...
//         spcData: [0.8, 0.8, 0.9, 0.8, 0.8, 0.9, 0.8, 1.2, 2.1, 4.5, 4.8, 4.6, 4.9, 4.7, 4.5, 4.8, 4.9, 5.0],
//         alarms: [
//             { id: "ALM-105", name: "DISPENSE PUMP PRESSURE FLUCTUATION — BUBBLE DETECT", level: "warning", time: "09:34:12", params: { "Trigger": "Pressure variance >1.5 PSI", "Window": "Active dispense", "Interlock": "Soft Lock", "Lot": "WF-2024-0448" } },
//             { id: "ALM-106", name: "RESIST BOTTLE LEVEL CRITICAL LOW", level: "critical", time: "09:34:05", params: { "Level": "4.2%", "Threshold": "<5%", "Degasser": "FLUCTUATING AMBER" } },
//             { id: "ALM-107", name: "DEFECT ADDER COUNT SPIKE", level: "critical", time: "09:35:01", params: { "Count": "500+ adders", "Baseline": "<5 adders", "Pattern": "Comet Tail / Circular Void" } },
//         ],
//         ocap: [
//             "Select [HOLD LOT] — do not move wafers to Etch or Ion Implant.",
//             "Select [VIEW DEFECT MAP] — confirm Circular Void or Comet Tail pattern.",
...
//         ],
//         troubleshootingSteps: [
//             { icon: "🔍", title: "Visual Inspection — Dispense Arm", description: "Observe PFA (Perfluoroalkoxy) tubing for silver streaks or physical gaps in the fluid column indicating air presence.", action: "VIEW DISPENSE ARM", alertMessage: "Silver streaks visible in PFA tubing — air gaps detected in dispense line. Resist bottle at 4.2% (below 5% threshold)." },
//             { icon: "📊", title: "Filter Differential Pressure Test", description: "Run Filter ΔP Test to check pressure drop across filter membrane. High ΔP indicates outgassing filter requiring replacement.", action: "FILTER ΔP TEST", alertMessage: "ΔP across filter membrane is HIGH — filter is outgassing. Replacement required before resuming production." },
//             { icon: "📉", title: "RTM Pressure Trace Review", description: "Review dispense RTM log for cavitation spikes or concave pressure dips in the 15.0 PSI plateau during active dispense window.", action: "FLAG PRESSURE DIP IN RTM", alertMessage: "RCA Confirmed: Pressure dip flagged in RTM log at 09:34:12 — cavitation spikes confirm air in dispense line." },
//         ],
//         restoreActions: [
//             { name: "Bottle Change", alertMessage: "Replacing empty resist bottle with fresh vented lot — Level restored to 100%.", primary: false },
//             { name: "Manual Purge (5x Dummy Dispense)", alertMessage: "Performing 5 dummy dispense cycles into drain — air pockets cleared from dispense tip.", primary: true },
...
//         ],
//         ocapFlow: [
//             { title: "CONTAINMENT", desc: "Hold Lot — do not move to Etch or Ion Implant (open circuits risk)", btnLabel: "HOLD LOT", btnClass: "", alertMsg: "Lot on HOLD — wafers quarantined.", state: "completed" },
//             { title: "METROLOGY VERIFICATION", desc: "View defect map — confirm Circular Void or Comet Tail pattern", btnLabel: "VIEW DEFECT MAP", btnClass: "", alertMsg: "Defect map confirmed: Comet Tail pattern at center.", state: "completed" },
//             { title: "ROOT CAUSE ANALYSIS", desc: "Toggle to Equipment Screen and flag Pressure Dip in Dispense RTM log", btnLabel: "FLAG PRESSURE DIP", btnClass: "rca", alertMsg: "RCA Confirmed: Pressure dip at 09:34:12 flagged.", state: "active" },
//             { title: "HARDWARE RECOVERY", desc: "Bottle Change + System Purge — 15 min downtime + $500 resist cost", btnLabel: "BOTTLE CHANGE + PURGE", btnClass: "recovery", alertMsg: "Bottle changed. System purge complete.", state: "" },
//             { title: "DISPOSITION", desc: "Strip & Rework — coating defect is recoverable (unlike thermal/PEB)", btnLabel: "STRIP & REWORK", btnClass: "disposition", alertMsg: "Wafers sent to Pre-wet/Solvent Strip station.", state: "" },
//             { title: "VALIDATION", desc: "Run 3-wafer thickness check — uniformity must return to <1.0%", btnLabel: "3-WAFER THICKNESS CHECK", btnClass: "", alertMsg: "Validation complete: Uniformity = 0.8% → Tool status GREEN.", state: "" },
//         ],
//     },
//     {
//         id: "FM-005",
...
//         recipe: "EBR_SOLVENT_15ML",
//         keyInfo: "<strong>EBR Nozzle Clog / Misalignment</strong> — The Edge Bead Removal process uses a solvent stream to remove photoresist from the wafer's extreme periphery. A <strong>clog</strong> reduces solvent momentum → incomplete removal (<em>Residual PR</em>). A <strong>misalignment</strong> shifts the removal boundary — either leaving resist that flakes off in subsequent tools (causing particles) or encroaching into the active die area (reducing yield). Flow rate dropped to 8.0 ml/min vs 15.0 ml/min target.",
//         physicsImpact: "Clog reduces solvent momentum causing incomplete edge PR removal. Misalignment causes either particle contamination in downstream tools or yield loss.",
//         zones: [
//             { label: "EBR FLOW", temp: "8.0 ml/min", status: "danger", note: "LOW FLOW" },
//             { label: "NOZZLE POS", temp: "147.2 mm", status: "danger", note: "MISALIGN" },
//             { label: "ZONE 3", temp: "OK", status: "healthy", note: "NORMAL" },
...
//             { label: "EBR Flow Rate", value: "8.0 ml/min (spec: 15.0 ml/min)", status: "danger" },
//         ],
//         interlock: "Soft Lock — tool completes current wafer but inhibits 'Load' command for next wafer.",
//         interlockType: "soft",
//         lifecycle: [
//             { icon: "🚿", label: "Nozzle\nClog", state: "done" },
//             { icon: "🔩", label: "Flow\nDrop", state: "done" },
...
//         spcData: [5, 6, 5, 7, 6, 8, 12, 25, 60, 110, 170, 195, 200, 205, 198, 202, 210, 208],
//         alarms: [
//             { id: "ALM-501", name: "EBR SOLVENT FLOW RATE LOW / UNSTABLE", level: "critical", time: "16:22:44", params: { "Trigger": "Flow <12.0 ml/min for >1 sec", "Actual": "8.0 ml/min", "Target": "15.0 ml/min", "Interlock": "Soft Lock", "Lot": "WF-2024-0461" } },
//             { id: "ALM-502", name: "EBR NOZZLE POSITION DEVIATION", level: "warning", time: "16:22:40", params: { "Target X": "148.5 mm", "Actual X": "147.2 mm", "Delta": "-1.3 mm", "Impact": "Removal boundary shift" } },
//             { id: "ALM-503", name: "EDGE DEFECT COUNT SPIKE — CLUSTER AT 297–300mm", level: "critical", time: "16:23:15", params: { "Count": ">200 adders", "Baseline": "<10", "Location": "297–300 mm radius", "Rule": "Cluster detection Rule 2" } },
//         ],
//         ocap: [
//             "Soft Lock active — complete current wafer, inhibit next wafer load.",
//             "Inspect EBR nozzle tip for photoresist residue buildup causing backpressure.",
...
//         ],
//         troubleshootingSteps: [
//             { icon: "🔍", title: "Nozzle Tip Inspection — Clog Check", description: "Visually inspect EBR nozzle tip for dried photoresist buildup.", action: "INSPECT EBR NOZZLE TIP", alertMessage: "Dried resist crust visible on 40% of nozzle tip orifice — partial clog confirmed." },
//             { icon: "📐", title: "Nozzle Position XY Verification", description: "Verify nozzle XY position coordinates against recipe setpoints.", action: "CHECK NOZZLE XY POSITION", alertMessage: "Nozzle X-position: 147.2 mm (Target: 148.5 mm). Delta = -1.3 mm. Arm teach drift confirmed." },
//             { icon: "💧", title: "Dummy Wafer EBR Flow Test", description: "Run EBR cycle on dummy wafer to measure actual flow rate and removal boundary.", action: "RUN EBR DUMMY TEST", alertMessage: "Dummy wafer test: Flow = 8.2 ml/min, Removal boundary at 147.0 mm. Both clog AND misalignment confirmed." },
//         ],
//         restoreActions: [
//             { name: "Nozzle Soak & Clean", alertMessage: "Soaking EBR nozzle tip in solvent — resist crust dissolved. Flow rate returned to 15.0 ml/min.", primary: false },
//             { name: "Replace Nozzle Tip Insert", alertMessage: "Replacing nozzle tip insert — clog cleared. Flow: 15.1 ml/min.", primary: true },
//             { name: "Re-Teach Nozzle XY Position", alertMessage: "Re-teaching nozzle XY position. New coordinates: X = 148.5 mm ✓.", primary: false },
//         ],
//         ocapFlow: [
//             { title: "CONTAINMENT", desc: "Soft Lock active — complete current wafer, inhibit next load", btnLabel: "CONFIRM SOFT LOCK", btnClass: "", alertMsg: "Soft Lock confirmed. Current wafer completing.", state: "completed" },
//             { title: "METROLOGY VERIFICATION", desc: "KLA scan — confirm edge defect cluster at 297–300 mm radius", btnLabel: "RUN KLA EDGE SCAN", btnClass: "", alertMsg: "KLA confirmed: >200 edge defects/wafer.", state: "completed" },
//             { title: "ROOT CAUSE ANALYSIS", desc: "Identify nozzle clog, misalignment, or both as root cause", btnLabel: "FLAG RCA — NOZZLE", btnClass: "rca", alertMsg: "RCA Confirmed: Dual failure — dried resist clog + arm teach drift.", state: "active" },
//             { title: "HARDWARE RECOVERY", desc: "Replace nozzle tip + re-teach XY position. Run dummy wafer verification.", btnLabel: "REPLACE + RE-TEACH", btnClass: "recovery", alertMsg: "Nozzle tip replaced. XY re-taught to 148.5 mm.", state: "" },
//             { title: "DISPOSITION", desc: "Evaluate lot — wafers with residual PR edge flaking risk may need strip", btnLabel: "EVALUATE EDGE WAFERS", btnClass: "disposition", alertMsg: "5 wafers with residual PR edge confirmed — sent for strip.", state: "" },
//             { title: "VALIDATION", desc: "Run 3-wafer EBR validation — flow and edge defect count must be nominal", btnLabel: "RUN EBR VALIDATION", btnClass: "", alertMsg: "Validation complete: Flow = 15.0 ml/min → Tool status GREEN.", state: "" },
//         ],
//     },
//     {
//         id: "FM-004",
...
//         recipe: "PR_COAT_SPIN_3000RPM",
//         keyInfo: "<strong>Exhaust Fan Failure</strong> — The track requires precise laminar airflow to remove solvent vapors (PGMEA) during spin-coating and drying. Fan failure causes solvent concentration to increase above the wafer surface, <strong>slowing evaporation rate</strong>. This results in a <em>thicker resist film</em> and <em>poor thickness uniformity</em>, as solvent mist may redeposit on the wafer creating <strong>drying marks</strong> or <strong>\"orange peel\"</strong> textures. <span style='color:#ff1744'>IMMEDIATE HARD LOCK triggered — safety hazard (flammable PGMEA vapors).</span>",
//         physicsImpact: "Without laminar exhaust airflow, PGMEA solvent vapors accumulate above the wafer, slowing evaporation. Results in thicker film, poor uniformity, drying marks, and orange-peel defects.",
//         zones: [
//             { label: "EXHAUST", temp: "0.10 m/s", status: "danger", note: "FAIL" },
//             { label: "FAN RPM", temp: "0 RPM", status: "danger", note: "STOPPED" },
//             { label: "VAPOR PPM", temp: "AMBER", status: "danger", note: "HIGH" },
...
//             { label: "Solvent Vapor PPM", value: "AMBER ZONE — HIGH", status: "warn" },
//         ],
//         interlock: "IMMEDIATE HARD LOCK — Robot (WPR) inhibited from placing new wafers.",
//         interlockType: "hard",
//         lifecycle: [
//             { icon: "💨", label: "Fan\nFail", state: "done" },
//             { icon: "🌫️", label: "Vapor\nBuildup", state: "done" },
...
//         spcData: [5000, 5010, 5005, 5000, 5002, 5010, 5050, 5100, 5150, 5200, 5230, 5245, 5250, 5248, 5252, 5250, 5249, 5251],
//         alarms: [
//             { id: "ALM-305", name: "COATER CUP EXHAUST FLOW LOW — HARD LOCK", level: "critical", time: "14:55:02", params: { "Trigger": "Flow <0.35 m/s for >2 sec", "Actual": "0.10 m/s", "Setpoint": "0.50 m/s", "Interlock": "IMMEDIATE HARD LOCK", "Lot": "WF-2024-0455" } },
//             { id: "ALM-306", name: "EXHAUST FAN RPM = ZERO — MOTOR FAULT", level: "critical", time: "14:54:58", params: { "Fan Command": "100%", "Actual RPM": "0", "Diagnosis": "Motor burnout / belt break" } },
//             { id: "ALM-307", name: "SOLVENT VAPOR CONCENTRATION — AMBER ZONE", level: "warning", time: "14:55:10", params: { "Status": "AMBER — approaching flammable threshold", "Action": "Evacuate coater bay if RED" } },
//         ],
//         ocap: [
//             "IMMEDIATE: Confirm Hard Lock active — no new wafers into coater module.",
//             "Check exhaust fan belt for breakage or slippage.",
...
//         ],
//         troubleshootingSteps: [
//             { icon: "💨", title: "Exhaust Fan Belt & Motor Check", description: "Inspect exhaust fan belt for breakage or slippage. Measure motor current draw.", action: "INSPECT FAN MOTOR", alertMessage: "Fan belt BROKEN — zero resistance at pulley. Motor current normal." },
//             { icon: "🌫️", title: "Solvent Vapor PPM Monitor", description: "Check real-time PPM sensor in coater cup.", action: "CHECK VAPOR PPM", alertMessage: "Vapor PPM: 280 ppm (AMBER zone). Below RED threshold (500 ppm)." },
//             { icon: "🔌", title: "Exhaust Duct Blockage Inspection", description: "Physically inspect exhaust duct path for collapsed sections or blockages.", action: "INSPECT EXHAUST DUCT", alertMessage: "Exhaust duct clear — no blockage found. Root cause confirmed as fan belt failure." },
//         ],
//         restoreActions: [
//             { name: "Replace Exhaust Fan Belt", alertMessage: "Replacing broken fan belt — 20 min downtime. Fan RPM restoring to nominal 1750 RPM.", primary: true },
//             { name: "Replace Fan Motor", alertMessage: "Replacing fan motor — 45 min downtime.", primary: false },
//             { name: "Clear Exhaust Duct Blockage", alertMessage: "Clearing exhaust duct restriction — airflow restored to 0.50 m/s.", primary: false },
//         ],
//         ocapFlow: [
//             { title: "CONTAINMENT", desc: "Confirm Hard Lock — no new wafers. Monitor vapor PPM for safety.", btnLabel: "CONFIRM HARD LOCK", btnClass: "", alertMsg: "Hard Lock confirmed. Robot WPR inhibited.", state: "completed" },
//             { title: "METROLOGY VERIFICATION", desc: "Measure airflow and confirm thickness shift on in-process wafers", btnLabel: "MEASURE AIRFLOW + THICKNESS", btnClass: "", alertMsg: "Airflow confirmed: 0.10 m/s. Thickness: 5250 Å (+5% shift).", state: "completed" },
//             { title: "ROOT CAUSE ANALYSIS", desc: "Identify fan belt failure, motor burnout, or duct blockage as root cause", btnLabel: "FLAG RCA — FAN BELT", btnClass: "rca", alertMsg: "RCA Confirmed: Fan belt broken — mechanical failure.", state: "active" },
//             { title: "HARDWARE RECOVERY", desc: "Replace fan belt — 20 min downtime. Verify RPM and airflow after repair.", btnLabel: "REPLACE FAN BELT", btnClass: "recovery", alertMsg: "Fan belt replaced. Fan RPM = 1750. Airflow = 0.52 m/s.", state: "" },
//             { title: "DISPOSITION", desc: "Evaluate affected wafers — thickness >3% shift may require strip and rework", btnLabel: "EVALUATE LOT", btnClass: "disposition", alertMsg: "Lot evaluated: 3 wafers scrapped. Remaining released.", state: "" },
//             { title: "VALIDATION", desc: "Run 3-wafer uniformity check — thickness must return to 5000 ±150 Å", btnLabel: "RUN VALIDATION", btnClass: "", alertMsg: "Validation complete: Thickness = 5005 Å → Tool status GREEN.", state: "" },
//         ],
//     },
//     {
//         id: "FM-003",
...
//         recipe: "DEV_TMAH_2.38PCT",
//         keyInfo: "<strong>Developer Concentration Drift</strong> — TMAH (Tetramethylammonium hydroxide) dissolves exposed resist areas. Dissolution rate is highly sensitive to normality (concentration). <strong>Higher concentration</strong> → increased dissolution → <em>Line Slimming</em> (smaller CD). <strong>Lower concentration</strong> → <em>Scumming / Under-development</em> (larger CD or residual resist in trenches). In-line conductivity sensor showing step-change deviation from 2.38% TMAH setpoint.",
//         physicsImpact: "TMAH dissolution rate is concentration-sensitive. Higher concentration causes Line Slimming. Lower concentration causes Scumming or Underdevelopment.",
//         zones: [
//             { label: "ZONE 1", temp: "2.38%", status: "healthy", note: "NOMINAL" },
//             { label: "ZONE 2", temp: "2.38%", status: "healthy", note: "NOMINAL" },
//             { label: "ZONE 3", temp: "2.51%", status: "danger", note: "HIGH CONC" },
...
//         spcData: [22.0, 22.0, 22.0, 21.9, 21.9, 21.9, 21.8, 21.7, 21.6, 21.4, 21.2, 21.0, 20.8, 20.6, 20.4, 20.2, 20.0, 19.8],
//         alarms: [
//             { id: "ALM-602", name: "DEVELOPER NORMALITY OUT OF RANGE", level: "critical", time: "11:12:33", params: { "Trigger": "Conductivity deviation >±2% for >5 sec", "Setpoint": "2.38% TMAH", "Actual": "2.51% TMAH", "Delta": "+0.13%", "Lot": "WF-2024-0452" } },
//             { id: "ALM-603", name: "CD-SEM TRENDING — LINE SLIMMING", level: "warning", time: "11:13:05", params: { "CD Target": "22.0 nm", "Actual": "19.8 nm", "Trend": "7-pt downward", "Rule": "SPC Rule 6" } },
//         ],
//         ocap: [
//             "Check chemical blending system — verify TMAH dilution ratio and DI water flow.",
//             "Check day-tank level — evaporation of DI water raises TMAH concentration.",
//             "Verify in-line conductivity sensor calibration against reference standard.",
//             "Review developer temperature — temperature drift changes dissolution rate.",
//             "Hold current lot — send wafers to CD-SEM for dimensional verification.",
//             "Flush and recirculate day-tank if concentration deviation >±5%.",
//         ],
//         troubleshootingSteps: [
//             { icon: "📡", title: "Conductivity Sensor Verification", description: "Verify in-line conductivity reading against reference titration standard.", action: "VERIFY CONDUCTIVITY READING", alertMessage: "Conductivity reading: 1.09 normalized (2.51% TMAH). Sensor reading is accurate." },
//             { icon: "🌡️", title: "Developer Temperature Check", description: "Check developer temperature at 23.0°C ±0.2°C.", action: "CHECK DEV TEMPERATURE", alertMessage: "Developer temperature: 23.4°C (0.4°C above target)." },
//             { icon: "🧪", title: "Day-Tank Level & Blending Check", description: "Inspect day-tank DI water level for evaporation.", action: "INSPECT DAY-TANK", alertMessage: "Day-tank DI water level LOW — evaporation has increased TMAH concentration from 2.38% to 2.51%." },
//         ],
//         restoreActions: [
//             { name: "Refill Day-Tank DI Water", alertMessage: "Refilling DI water in day-tank — TMAH concentration returning to 2.38%.", primary: false },
//             { name: "Recalibrate Blending System", alertMessage: "Recalibrating chemical blending controller — dilution ratio corrected to 2.38% TMAH setpoint.", primary: true },
//             { name: "Flush & Recirculate Day-Tank", alertMessage: "Flushing day-tank and recirculating at correct concentration.", primary: false },
//         ],
//         ocapFlow: [
//             { title: "CONTAINMENT", desc: "Hold lot — prevent under/over-developed wafers from escaping to etch", btnLabel: "HOLD LOT", btnClass: "", alertMsg: "Lot on HOLD — dimensional excursion contained.", state: "completed" },
//             { title: "METROLOGY VERIFICATION", desc: "CD-SEM review — confirm Line Slimming or Scumming pattern on wafers", btnLabel: "RUN CD-SEM REVIEW", btnClass: "", alertMsg: "CD-SEM confirmed: Line Slimming detected. Mean CD = 19.8 nm.", state: "completed" },
//             { title: "ROOT CAUSE ANALYSIS", desc: "Identify blending system fault or day-tank evaporation as root cause", btnLabel: "FLAG RCA — BLENDING", btnClass: "rca", alertMsg: "RCA Confirmed: Day-tank DI water evaporation raised TMAH from 2.38% to 2.51%.", state: "active" },
//             { title: "HARDWARE RECOVERY", desc: "Refill day-tank DI water + recalibrate blending controller", btnLabel: "REFILL + RECALIBRATE", btnClass: "recovery", alertMsg: "Day-tank refilled. Blending controller recalibrated.", state: "" },
//             { title: "DISPOSITION", desc: "Re-develop affected wafers if within CD budget window", btnLabel: "RE-DEVELOP WAFERS", btnClass: "disposition", alertMsg: "Affected wafers re-developed at correct concentration.", state: "" },
//             { title: "VALIDATION", desc: "Run 5-wafer lot — CD-SEM and conductivity trace must return to target", btnLabel: "RUN VALIDATION", btnClass: "", alertMsg: "Validation complete: CD = 22.0 nm → Tool status GREEN.", state: "" },
//         ],
//     },
// ];
...
//         if (!canvas) return;
//         if (isPEB && pebScenario) {
//             const ZONE_COLORS = { z1: '#7abfbf', z2: '#e05c5c', z3: '#ccccaa', z4: '#d64343', z5: '#7fc97f' };
//             const ZONE_DS_ORDER = [ZONE_COLORS.z1, ZONE_COLORS.z2, ZONE_COLORS.z3, ZONE_COLORS.z4, ZONE_COLORS.z5];
//             if (pebScenario === 1 || pebScenario === 3) {
//                 const FAIL_PT = 210;
//                 const temps = getScenario13Temps(FAIL_PT);
...
//     const [ocapStep, setOcapStep] = useState(1);
//     const [validationClicks, setValidationClicks] = useState({ marathon: false, cdBaseline: false });
...
//     const handleOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
//         if (ocapStep !== requiredStep) { showFlowError(); return false; }
//         alert(successMsg);
...
//     const [rdbOcapStep, setRdbOcapStep] = useState(1);
//     const [rdbActionsDone, setRdbActionsDone] = useState({ filter: false, bottle: false });
//     const [rdbValidationClicks, setRdbValidationClicks] = useState({ thicknessCheck: false, uniformityBaseline: false });

//     const showRdbFlowError = () => alert("Please follow the OCAP flow: Containment → Verification → Root Cause → Actions → Validation → Release");

//     const handleRdbOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
//         if (rdbOcapStep !== requiredStep) { showRdbFlowError(); return false; }
//         alert(successMsg);
//         if (nextStep) setRdbOcapStep(nextStep);
//         return true;
//     };

//     const handleRdbActionClick = (actionType: 'filter' | 'bottle', successMsg: string) => {
//         if (rdbOcapStep !== 4) { showRdbFlowError(); return false; }
//         alert(successMsg);
//         setRdbActionsDone(prev => {
//             const updated = { ...prev, [actionType]: true };
//             if (dpMode === 'high') { if (updated.filter && updated.bottle) setRdbOcapStep(5); }
//             else { if (updated.bottle) setRdbOcapStep(5); }
//             return updated;
//         });
//         return true;
//     };
...
//     const handleRdbRootCauseClick = () => {
//         if (rdbOcapStep !== 3) { showRdbFlowError(); return false; }
//         if (dpMode === 'high') alert('Root cause completed: HIGH ΔP detected — filter replacement / filter prime required');
//         else alert('Root cause completed: NORMAL ΔP detected — air pocket due to empty resist bottle');
//         setRdbOcapStep(4);
//         return true;
//     };

//     const [ebrOcapStep, setEbrOcapStep] = useState(1);
//     const [ebrValidationClicks, setEbrValidationClicks] = useState({ dummyWafer: false, baseline: false });

//     const showEbrFlowError = () => alert("Please follow the OCAP flow: Containment → Verification → Root Cause → Actions → Validation → Release");

//     const handleEbrOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
//         if (ebrOcapStep !== requiredStep) { showEbrFlowError(); return false; }
//         alert(successMsg);
//         if (nextStep) setEbrOcapStep(nextStep);
//         return true;
//     };

//     const [exfOcapStep, setExfOcapStep] = useState(1);
//     const [exfValidationClicks, setExfValidationClicks] = useState({ thicknessCheck: false, defectMap: false });

//     const showExfFlowError = () => alert("Please follow the OCAP flow: Containment → Verification → Root Cause → Actions → Validation → Release");

//     const handleExfOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
//         if (exfOcapStep !== requiredStep) { showExfFlowError(); return false; }
//         alert(successMsg);
//         if (nextStep) setExfOcapStep(nextStep);
//         return true;
//     };

//     const [devOcapStep, setDevOcapStep] = useState(1);

//     const showDevFlowError = () => alert("Please follow the OCAP flow: Containment → Verification → Root Cause → Actions → Validation → Release");

//     const handleDevOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
//         if (devOcapStep !== requiredStep) { showDevFlowError(); return false; }
//         alert(successMsg);
//         if (nextStep) setDevOcapStep(nextStep);
//         return true;
//     };

//     const handlePebRepairAction = (expectedScenario: 1 | 2 | 3, repairType: 'heater' | 'tc' | 'ssr', successMsg: string) => {
//         if (ocapStep !== 4) { showFlowError(); return; }
//         if (pebScenario !== expectedScenario) { alert('ERROR: REPLACED PART DOES NOT MATCH FAILURE SCENARIO'); return; }
//         setSelectedRepair(repairType);
//         alert(successMsg);
//         setOcapStep(5);
//     };

//     const [devActionsDone, setDevActionsDone] = useState({ primary: false, flush: false });

//     const handleDevActionClick = (actionType: "primary" | "flush", successMsg: string) => {
//         if (devOcapStep !== 4) { showDevFlowError(); return false; }
//         alert(successMsg);
//         setDevActionsDone(prev => {
//             const updated = { ...prev, [actionType]: true };
//             if (updated.primary && updated.flush) setDevOcapStep(5);
//             return updated;
//         });
//         return true;
//     };
...
//                         {/* FM-002: Resist Dispense Bubble — 3-col layout */}
//                         {fm.name === "Resist Dispense Bubble" && (
//                             <div className="grid grid-cols-1 lg:grid-cols-3 gap-2.5">
//                                 {/* RTM Chart */}
//                                 <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
//                                     <div className="flex items-center justify-between flex-wrap gap-1.5">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ RTM — {fm.rtmLabel}</span>
//                                     </div>
//                                     <div className="flex flex-wrap gap-1.5">
//                                         <span className="font-mono text-[11px] px-1.5 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400 border border-green-500/25">NORMAL: {fm.rtmNormalValue}</span>
//                                         <span className="font-mono text-[11px] px-1.5 py-0.5 rounded bg-red-500/10 text-red-600 dark:text-red-400 border border-red-500/25">FAILURE: {fm.rtmFailureValue}</span>
//                                     </div>
//                                     <div className="font-mono text-[10px] text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded px-2 py-0.5">
//                                         📡 SENSOR: {fm.rtmSensorLabel}
//                                     </div>
//                                  <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
//     <Image src="/RTMPUMPResistDispenseBubble.png" alt="RTM Pump Pressure" width={1400} height={500} className="w-full h-auto block mt-4"/>
// </div>
//                                 </div>

//                                 {/* Active Alarm Log */}
//                                 <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
//                                     <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ ACTIVE ALARM LOG</span>
//                                     <div className="w-full flex-1 min-h-[200px] rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
//                                         <Image src="/RTMPUMPResist.png" alt="Alarm Log" width={1400} height={500} className="w-full h-full object-fill" />
//                                     </div>
//                                 </div>

//                                 {/* Wafer Defect Map */}
//                                 <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
//                                     <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ WAFER DEFECT MAP</span>
//                                     <div className="w-full flex-1 min-h-[200px] rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
//                                         <Image src="/waffermapmodule.png" alt="Wafer Defect Map" width={400} height={320} className="w-full h-full object-fill block" />
//                                     </div>
//                                 </div>
...
//                                     <div className="flex items-center justify-between flex-wrap gap-1.5">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ PROCESS SPC CHART Thickness Uniformity</span>
//                                     </div>
//                                     {fm.spcMetrics && (
//                                         <div className="flex flex-wrap gap-1.5">
//                                             {fm.spcMetrics.map((m, i) => (
//                                                 <span key={i} className="font-mono text-[11px] px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">{m}</span>
//                                             ))}
//                                         </div>
//                                     )}
//                                     <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
//                                         <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
//                                          <Image src="/spc-ResistDispenseBubble.png" alt="SPC Chart" width={700} height={300} className="w-full h-auto block" />
//                                          </div>
//                                         <div className="flex flex-col gap-2">
//                                             <div className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">Offline Defect Adder Count</div>
//                                            <div className="flex-1 rounded-lg border border-gray-200 dark:border-gray-700 bg-white flex items-center justify-center">
//     <Image src="/defect-ResistDispenseBubble.png" alt="Offline Defect" width={500} height={400} className="w-full h-auto block" style={{marginBottom: '-5%'}} />
// </div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                         {/* FM-005: EBR Nozzle Clog/Misalign */}
//                         {fm.name === "EBR Nozzle Clog/Misalign" && (
...
//                                             📡 SENSOR: {fm.rtmSensorLabel}
//                                         </div>
//                                       <div className="w-full h-56 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
//     <Image src="/EBBNozzleClogMisalignRTM.png" alt="EBR Nozzle RTM" width={1400} height={500} className="w-full h-full object-fill" />
// </div>
//                                     </div>

//                                     {/* Failure Diagnostics */}
//                                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ FAILURE DIAGNOSTICS</span>
//                                         <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
//     <Image src="/deffectspret.png" alt="EBR Wafer Defect Map" width={400} height={320} className="w-full h-auto object-contain block" />
// </div>
//                                     </div>
//                                 </div>
...
//                                       <div className=" lg:w-[50%] rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white h-80">
//     <Image src="/EBBNozzleClogMisalignSPC.jpeg" alt="SPC Chart" width={700} height={300} className="w-full h-full object-fill" />
// </div>
//                                         <div className=" flex lg:w-[25%] w-full flex-col p-3 gap-2">
//                                             <div className="font-mono text-xs font-bold tracking-wider text-gray-500  w-full h-fit dark:text-gray-400">Offline Defect Adder Count</div>
//                                             <div className="rounded-lg overflow-hidden w-full h-full border border-gray-200 dark:border-gray-700 bg-white  w-40">
//     <Image src="/EBBNozzleClogMisaligndeffect.png" alt="Offline Defect" width={350} height={350} className="w-full h-80 object-fill" />
// </div>
//                                         </div>
//                                         <div className="md:col-span-1 bg-gray-100 dark:bg-gray-900 border border-gray-200 lg:w-[25%] w-full dark:border-gray-700 rounded-lg p-3 text-xs leading-relaxed text-gray-600 dark:text-gray-400">
//                                             <div className="font-mono text-sm tracking-wider text-blue-600 dark:text-blue-400 mb-1">FAILURE MODE</div>
//                                             <div className="text-xs font-bold text-gray-800 dark:text-gray-200 mb-1.5">EBR NOZZLE CLOG / MISALIGN</div>
//                                             <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">FMEA Severity:</strong> 8/10 High</div>
//                                             <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">Physics Impact:</strong> Clog reduces solvent momentum causing residual PR. Misalignment shifts removal boundary.</div>
//                                             <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">RTM Sensor:</strong> EBR Solvent Flow Meter</div>
//                                             <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">Alarm:</strong> ALM-501 — EBR solvent flow rate low / unstable</div>
//                                             <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">SPC Metric:</strong> Offline Defect Adder Count — Edge Exclusion Zone</div>
//                                             <div><strong className="text-gray-800 dark:text-gray-200">Rules:</strong> 1 point outside 3-Sigma + edge cluster detection</div>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                     {/* Rmt Chats */}
//                                     <div className="bg-white dark:bg-gray-800 lg:w-[55%] w-full border  border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 hover:border-blue-500/30 transition-colors">
//                                     <div className="flex items-center justify-between flex-wrap gap-1.5">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ RTM — {fm.rtmLabel}</span>
//                                     </div>
//                                     <div className="flex flex-wrap gap-1.5">
...
//                                     </div>
//                                     <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
//     <Image src="/ExhaustFanFailureRTMAlaram.png" alt="Exhaust Fan Failure RTM" width={1400} height={500} className="w-full h-auto block" style={{marginBottom: '-12%'}} />
// </div>
//                                 </div>

//                                     <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white">
//                                         <Image src="/viewthikness.png" alt="View Thickness" width={1200} height={780} className="w-full h-86 object-fill block mt-12" />
//                                     </div>
                                    
//                                     <div className="p-5 bg-blue-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg lg:w-96 flex flex-col justify-center">
//                                         <h3 className="mb-4 text-xl font-bold text-blue-800 dark:text-blue-400 text-center border-b pb-2.5 border-gray-300 dark:border-gray-600">Exhaust Failure Analysis</h3>
//                                         <div className="mb-3 leading-6 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">Severity:</strong> High</div>
//                                         <div className="mb-3 leading-6 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">Impact:</strong> Reduced exhaust airflow causes solvent accumulation and resist thickness variation.</div>
//                                         <div className="mb-3 leading-6 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">RTM Indicator:</strong> Cup exhaust velocity drops below normal operating range.</div>
//                                         <div className="mb-3 leading-6 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">Wafer Effect:</strong> Thickness non-uniformity, drying marks and process instability.</div>
//                                     </div>
//                                 </div>

//                                 {/* Wafer Defect Map */}
//                                 <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 hover:border-blue-500/30 transition-colors">
//                                     <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ WAFER DEFECT MAP</span>
//                                    <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 px-4">
//     <Image src="/ExhaustFanFailureProcessscreen.png" alt="Exhaust Fan Process Screen" width={400} height={420} className="w-full h-88 object-fill block" />
// </div>
//                                 </div>
//                             </div>
//                         )}

//                         {/* FM-003: Developer Concentration */}
//                         {fm.name === "Developer Concentration" && (
//                             <div className="flex flex-col gap-2.5">
//                                 <div className="flex lg:flex-row flex-col gap-2.5">
//                                     {/* RTM Chart */}
//                                     <div className="bg-white lg:w-[50%] w-full dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
//                                         <div className="flex items-center justify-between flex-wrap gap-1.5">
//                                             <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ RTM — {fm.rtmLabel}</span>
//                                         </div>
//                                         <div className="flex flex-wrap gap-1.5">
...
//                                             📡 SENSOR: {fm.rtmSensorLabel}
//                                         </div>
//                                         <div className="w-full h-52 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
//                                             <Image src="/DeveloperconcentrationRTM.png" alt="Developer Concentration RTM" width={1400} height={500} className="w-full h-full object-fill" />
//                                         </div>
//                                     </div>

//                                     {/* Info Panel */}
//                                     <div className="bg-white lg:w-[50%] dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-visible">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ FAILURE MODE DEVELOPER CONCENTRATION</span>
//                                         <div className="flex flex-col sm:flex-row gap-3 flex-1">
//                                             <div className="flex-1 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white min-h-[200px]">
//                                                 <Image src="/regonia5thmodule.png" alt="Developer Concentration" width={240} height={320} className="w-full h-full object-contain block" />
//                                             </div>
//                                             <div className="flex-1 bg-blue-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-md">
//                                                 <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">FMEA Severity:</strong> High</div>
//                                                 <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">Impact:</strong> Incorrect concentration causes CD variation and line slimming.</div>
//                                                 <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">RTM:</strong> Developer conductivity drift / concentration increase.</div>
//                                                 <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">SPC:</strong> Offline CD-SEM critical dimension trend.</div>
//                                             </div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-2.5 pt-2.5 pb-1 flex flex-col gap-1.5">
//                                         <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ PROCESS SPC CHART Thickness Uniformity</span>
//                                         {fm.spcMetrics && (
//                                             <div className="flex flex-wrap gap-1.5">
//                                                 {fm.spcMetrics
//                                                     .filter(m => !(fm.name === "Developer Concentration" && m === "Unresolved Feature / Scumming Count (KLA SEM Review)"))
//                                                     .map((m, i) => (
//                                                         <span key={i} className="font-mono text-[11px] px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">{m}</span>
//                                                     ))}
//                                             </div>
//                                         )}
//                                         <div className="w-full h-fit  rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
//                                             <Image src="/DeveloperconcentrationSPC.png" alt="SPC Chart" width={700} height={500} className="w-full h-72 object-fill object-center object-cover" />
//                                         </div>
//                                     </div>

//                                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5">
//                                         <div className="self-start px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-blue-50 dark:bg-gray-800 text-sm text-blue-800 dark:text-blue-400 font-medium">
//                                             Unresolved Feature / Scumming Count (KLA SEM Review)
//                                         </div>
//                                         <div className="flex-1 h-80 border border-gray-200 dark:border-gray-700 bg-black rounded-lg bg-white p-2 min-h-[260px]">
//                                             <Image src="/DeveloperConcentrationklascan.png" alt="Developer Concentration KLA Scan" width={700} height={500} className="w-full h-72 object-fill object-center object-cover"/>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                     <a href="/" className="font-sans text-[10px] font-bold tracking-wider px-3 py-1 rounded text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all">HOME</a>
//                 </div>
...
//                 <div className="font-sans text-lg font-black text-gray-800 dark:text-gray-200 mb-2">SMaRT Simulator</div>
...
//                             onClick={() => selectFM(idx)}
//                         >
//                             <div className="text-base font-extrabold text-gray-800 dark:text-gray-200 leading-tight tracking-wide">{mode.name}</div>
//                         </div>
//                     ))}
//                 </div>
...
//                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg flex-1 p-2">
//                         <div className="font-mono text-base text-black dark:text-white tracking-widest mb-1.5">⬡ KEY INFORMATION</div>
//                         <div className="text-xs text-gray-800 dark:text-gray-200 leading-relaxed" dangerouslySetInnerHTML={{ __html: fm.keyInfo }} />
//                     </div>

//                     {isPEB && (
//                         <div className="w-full lg:w-80 flex-shrink-0">
//                             <Image src="/thermo-couple.png" alt="Thermocouple Image" width={320} height={200} className={`w-full ${isPEB?"h-52":"h-28"}  rounded-lg block object-cover`} />
//                         </div>
//                     )}

//                     {fm.name === "Resist Dispense Bubble" && (
//                         <div className="w-full lg:w-96 flex-shrink-0">
//                             <Image src="/visualinspection.png" alt="Visual Inspection" width={320} height={200} className="w-full h-28 rounded-lg block lg:object-fill  object-contain" />
//                         </div>
//                     )}
//                 </div>

//                 {/* SCENARIOS (PEB only) + LOT ID / RECIPE */}
//                 <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
//                     {/* Scenario buttons — PEB only */}
//                     {isPEB && (
//                         <div className="flex flex-col sm:flex-row gap-2 flex-1">
//                             {([1, 2, 3] as const).map((sc) => {
//                                 const labels: Record<number, string> = { 1: 'Failing Heating Element', 2: 'Broken Thermocouple', 3: 'Blown Solid State Relay (SSR)' };
//                                 return (
//                                     <button
//                                         key={sc}
//                                         className={`flex-1 bg-blue-500/5 border border-gray-200 dark:border-gray-700 px-4 py-2.5 cursor-pointer transition-all duration-200 flex flex-col justify-center gap-1 rounded-lg text-left ${pebScenario === sc ? 'bg-gradient-to-br from-blue-500/15 to-blue-500/5 border-blue-500 shadow-[0_0_10px_rgba(0,102,204,0.14)]' : ''}`}
//                                         onClick={() => setPebScenario(pebScenario === sc ? null : sc)}
//                                     >
//                                         <span className="font-sans text-base font-black tracking-wide text-gray-500 dark:text-gray-500">SCENARIO {sc}</span>
//                                         <span className="text-[11px] font-semibold text-gray-800 dark:text-gray-200 leading-tight">{labels[sc]}</span>
//                                     </button>
//                                 );
//                             })}
//                         </div>
...
//                     {/* LOT ID + RECIPE — always visible, right-aligned for PEB, left for others */}
//                    {isPEB&& <div className={`flex flex-col  gap-2 ${isPEB ? 'flex-shrink-0' : 'w-full sm:w-auto'}`}>
//                         <div className="bg-gradient-to-br from-white/5 to-white/1 border border-gray-200 bg-white dark:border-gray-700 rounded-lg px-3 h-8 flex items-center">
...
//                             </span>
//                         </div>
//                         <div className="bg-gradient-to-br from-white/5 to-white/1 bg-white border border-gray-200 dark:border-gray-700 rounded-lg px-3 h-8 flex items-center">
//                             <span className="font-mono text-[11px] font-bold flex items-center gap-1 whitespace-nowrap">
...
//                 {/* Scenario info bar — PEB only */}
//                 {pebSc && (
//                     <div className={`rounded-lg p-2.5 flex flex-col sm:flex-row items-start sm:items-center gap-2.5 border-l-4 ${pebScenario === 1 ? 'border-l-orange-500 bg-orange-500/10' : pebScenario === 2 ? 'border-l-red-600 bg-red-600/10' : 'border-l-green-600 bg-green-600/10'}`}>
//                         <div className="text-xl flex-shrink-0">{pebSc.icon}</div>
//                         <div className="flex-1 text-xs text-gray-800 dark:text-gray-200 leading-relaxed">{pebSc.desc}</div>
//                         {pebSc.warn && (
//                             <div className="bg-orange-500/15 border border-orange-500/40 rounded px-2.5 py-1 text-[10px] text-orange-500 font-mono flex-shrink-0">{pebSc.warn}</div>
//                         )}
//                     </div>
//                 )}
...
//                         <button
//                             className={`flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 font-sans text-sm font-bold tracking-wider text-gray-600 dark:text-gray-400 cursor-pointer transition-all duration-200 text-left ${(activeTab === 'rtmspc' || activeTab === null) ? 'border-blue-500 bg-gradient-to-br from-blue-500/15 to-blue-500/5 text-blue-600 dark:text-blue-400 shadow-[0_0_10px_rgba(0,102,204,0.14)]' : ''}`}
//                             onClick={() => setActiveTab(activeTab === 'rtmspc' ? null : 'rtmspc')}
//                         >
//                             ⬡ Equipment RTM / Process SPC chart
//                         </button>
//                         <button
//                             className={`flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 font-sans text-sm font-bold tracking-wider text-gray-600 dark:text-gray-400 cursor-pointer transition-all duration-200 text-left ${(activeTab === 'troubleshooting' || activeTab === 'ocap') ? 'border-blue-500 bg-gradient-to-br from-blue-500/15 to-blue-500/5 text-blue-600 dark:text-blue-400 shadow-[0_0_10px_rgba(0,102,204,0.14)]' : ''}`}
//                             onClick={toggleTroubleshooting}
//                         >
//                             ⬡ Equipment troubleshooting, Process OCAP (Out of Control Action Plan)
//                         </button>
...
//                 {/* PEB no scenario prompt */}
//                 {isPEB && !pebScenario && (
//                     <div className="flex items-center gap-3.5 bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 mt-1">
//                         <span className="text-2xl text-blue-600 dark:text-blue-400 opacity-60 flex-shrink-0">⬡</span>
//                         <span className="font-sans text-lg text-gray-500 dark:text-gray-500 tracking-wide leading-relaxed">Please select a scenario above to view RTM charts, SPC data, wafer map and troubleshooting tools</span>
//                     </div>
//                 )}

//                 {/* DANGER ZONE BANNER — PEB only */}
//                 {isPEB && pebSc && (
//                     <div className="bg-white dark:bg-gray-800 border border-red-500/35 rounded-lg p-3">
//                         <div className="flex items-center gap-2.5 mb-3">
//                             <span className="text-base text-red-600 dark:text-red-500 animate-pulse">⚠</span>
//                             <span className="font-sans text-[11px] font-bold tracking-wider text-red-600 dark:text-red-500 flex-1">ZONE {pebSc.dangerZone} — CRITICAL DEVIATION DETECTED</span>
//                         </div>
//                         <div className="flex flex-wrap sm:flex-nowrap gap-2">
//                             {fm.zones.map((z, idx) => {
//                                 const isDanger = idx === dangerZoneIndex;
//                                 return (
//                                     <div key={z.label} className={`flex-1 min-w-[60px] rounded-lg p-2 flex flex-col items-center gap-1 text-center transition-all duration-200 ${isDanger ? 'bg-red-600/10 border-2 border-red-600 shadow-[0_0_14px_rgba(217,0,38,0.2)]' : 'bg-green-500/5 border border-green-500/20'}`}>
//                                         <div className="font-sans text-xs font-black tracking-wide text-black dark:text-white">{z.label}</div>
//                                         <div className={`font-sans text-sm font-black ${isDanger ? 'text-red-600 dark:text-red-500' : 'text-green-600 dark:text-green-400'}`}>{isDanger ? pebSc.dangerTemp : z.temp}</div>
//                                         <div className={`text-[8px] font-mono tracking-wide ${isDanger ? 'text-red-400 font-bold' : 'text-gray-500 dark:text-gray-500'}`}>{isDanger ? pebSc.dangerStatus : z.note}</div>
//                                     </div>
//                                 );
//                             })}
//                         </div>
...
//                 {/* EQUIPMENT TROUBLESHOOTING — FM-001 */}
//                 {activeTab === 'troubleshooting' && isPEB && (
//                     <div className="w-full">
//                         <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg items-start">

//                             {/* LEFT COLUMN */}
//                             <div className="flex flex-col gap-3 w-full">
//                                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
//                                     {/* 1. Containment */}
//                                     <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                         <div className="text-base font-extrabold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">1.Containment &amp; Disposition</div>
//                                         <button
//                                             className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
//                                             onClick={() => handleOcapClick(1, 'Perform Tool LOTO (Lock Out Tag Out); Scrap wafers', 2)}
//                                         >
//                                             Perform Tool LOTO (Lock Out Tag Out); Scrap wafers
//                                         </button>
//                                     </div>
...
//                                     {/* 2. Verification */}
//                                     <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                         <div className="text-base font-extrabold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">2.Verification</div>
//                                         <button
//                                             className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
//                                             onClick={() => handleOcapClick(2, 'Re-measure wafer CD. Result: Same as 1st measurement; Troubleshoot tool', 3)}
//                                         >
//                                             Re-measure wafer CD. Result: Same as 1st measurement;
//                                         </button>
//                                     </div>
...
//                                 {/* 3. Root Cause Table */}
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/3">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-3">3.Root cause</div>
//                                     <button
//                                         className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400 mb-3"
//                                         onClick={() => handleOcapClick(3, 'Root cause analysis completed. Proceed to Actions.', 4)}
//                                     >
//                                         Confirm Root Cause
//                                     </button>
//                                     <div className="w-full overflow-x-auto">
//                                         <table className="min-w-[720px] w-full border-collapse text-[9px] font-mono">
//                                             <thead>
//                                                 <tr>
//                                                     {['ROOT CAUSE ANALYSIS', 'ZONE 4 TEMPERATURE', 'ZONE 4 DUTY CYCLE', 'HEATER OHMIC TEST', 'TC SENSOR OHMIC TEST', 'SSR OHMIC TEST', 'HEATER VISUAL INSPECTION', 'CD (nm)'].map(h => (
//                                                         <th key={h} className="px-3 py-1.5 text-xs whitespace-normal break-words bg-black/30 dark:bg-black/30">{h}</th>
//                                                     ))}
//                                                 </tr>
//                                             </thead>
//                                             <tbody>
//                                                 <tr className="border-b border-gray-200 dark:border-gray-800">
//                                                     <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">HEATER FAIL</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">REDUCES TO AMBIENT</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">PINNED AT 100%</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500 font-extrabold">OPEN</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500">BURN SPOT</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">DOWN SHIFT, OOC</td>
//                                                 </tr>
//                                                 <tr className="border-b border-gray-200 dark:border-gray-800">
//                                                     <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">TC BROKEN</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">FLUCTUATES</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">FLUCTUATES</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500 font-extrabold">OPEN</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">MORE VARIABILITY, OOC</td>
//                                                 </tr>
//                                                 <tr>
//                                                     <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">SSR FAIL</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">REDUCES TO AMBIENT</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-yellow-500">PINNED AT 100%</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
//                                                     <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
...
//                                 {/* 4. Actions */}
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-base font-extrabold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">4.Actions</div>
//                                     <div className="flex flex-col sm:flex-row gap-3 items-start">
//                                         <div className="flex flex-col gap-2 flex-1 w-full">
//                                             {[
//                                                 { sc: 1 as const, type: 'heater' as const, label: 'Replace faulty heater' },
//                                                 { sc: 2 as const, type: 'tc' as const, label: 'Replace faulty Thermocouple' },
//                                                 { sc: 3 as const, type: 'ssr' as const, label: 'Replace faulty SSR' },
//                                             ].map(item => (
//                                                 <button key={item.type}
//                                                     className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
//                                                     onClick={() => handlePebRepairAction(item.sc, item.type, `VALIDATION SUCCESS: Replacing faulty ${item.label.replace('Replace faulty ', '')}`)}
//                                                 >
//                                                     {item.label}
//                                                 </button>
//                                             ))}
//                                         </div>
//                                         <div className="flex-1 text-sm leading-relaxed text-gray-500 dark:text-gray-500 border-l border-blue-500/15 pl-3">
//                                             <strong className="block text-gray-800 dark:text-gray-200 mb-1.5">Details of actions:</strong>
//                                             <p>Replace relevant hardware element depending on the selected failure scenario.</p>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                 {/* 5. Validation */}
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-base font-extrabold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">5.Validation</div>
//                                     <div className="flex flex-col sm:flex-row gap-3 items-start">
//                                         <div className="flex flex-col gap-2 flex-1">
//                                             <button
//                                                 className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
//                                                 onClick={() => {
//                                                     if (ocapStep !== 5) { showFlowError(); return; }
//                                                     alert('Running 5-wafer Marathon test — all zones heating normally.');
//                                                     setValidationClicks(prev => ({ ...prev, marathon: true }));
//                                                 }}
//                                             >
//                                                 Run 5 wafer Marathon test
//                                             </button>
...
//                                                 onClick={() => {
//                                                     if (ocapStep !== 5) { showFlowError(); return; }
//                                                     alert('CD and CD uniformity measurement complete — returned to baseline. Tool status: GREEN (PROD).');
//                                                     setValidationClicks(prev => {
//                                                         const updated = { ...prev, cdBaseline: true };
//                                                         if (updated.marathon && updated.cdBaseline) setOcapStep(6);
//                                                         return updated;
//                                                     });
//                                                 }}
//                                             >
...
//                                             <img src="/cduniformity.png" alt="CD Uniformity" className="w-44 h-24 object-contain rounded" />
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                 {/* 6. Release & Monitor */}
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-base font-extrabold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">6.Release &amp; Monitor</div>
//                                     <button
//                                         className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
//                                         onClick={() => handleOcapClick(6, 'Release tool for production; Record OCAP data base', 7)}
//                                     >
//                                         Release tool for production; Record OCAP data base
//                                     </button>
//                                 </div>
...
//                 {/* EQUIPMENT TROUBLESHOOTING — FM-002 Resist Dispense Bubble */}
//                 {activeTab === 'troubleshooting' && fm.id === 'FM-002' && (
//                     <div className="w-full">
//                         <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg">
//                             {/* LEFT */}
//                             <div className="flex flex-col gap-3">
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">1.Containment &amp; Disposition</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleRdbOcapClick(1, 'Perform Tool LOTO (Lock Out Tag Out); Hold lot, Strip & rework wafers', 2)}>
//                                         Perform Tool LOTO (Lock Out Tag Out);<br />Hold lot, Strip &amp; rework wafers
//                                     </button>
//                                 </div>

//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5 flex-1">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">3.Root cause</div>
//                                     <button
//                                         className={`w-full bg-gray-500/10 border text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-2.5 ${dpMode === 'high' ? 'border-red-500 shadow-[0_0_12px_rgba(255,23,68,0.35)]' : 'border-green-500 shadow-[0_0_12px_rgba(0,200,83,0.35)]'}`}
//                                         onClick={() => handleRdbOcapClick(3, dpMode === 'high' ? 'Root cause completed: HIGH ΔP detected' : 'Root cause completed: NORMAL ΔP detected', 4)}
//                                     >
//                                         1. Perform filter ΔP test to decide on filter replacement
//                                     </button>
//                                     <div className="flex gap-2 mb-2.5">
//                                         {(['high', 'normal'] as const).map(mode => (
//                                             <button key={mode} type="button"
//                                                 className={`flex-1 py-1.5 px-2.5 rounded border border-blue-500/30 bg-white/5 text-gray-500 dark:text-gray-400 font-extrabold cursor-pointer transition duration-300 ${dpMode === mode ? (mode === 'high' ? 'bg-red-500/20 border-red-500 text-red-500' : 'bg-green-500/20 border-green-500 text-green-500') : ''}`}
//                                                 onClick={() => setDpMode(mode)}>
...
//                                         {dpMode === 'high' ? (
//                                             <svg viewBox="0 0 180 100" xmlns="http://www.w3.org/2000/svg" className="w-full block">
//                                                 <rect width="180" height="100" fill="#0a0a0a" rx="6" />
//                                                 <path d="M 22 82 A 68 68 0 0 1 158 82" fill="none" stroke="#1a1a1a" strokeWidth="16" strokeLinecap="round" />
//                                                 <path d="M 22 82 A 68 68 0 0 1 158 82" fill="none" stroke="#ff1744" strokeWidth="16" strokeLinecap="round" strokeDasharray="215" strokeDashoffset="0" />
//                                                 <path d="M 22 82 A 68 68 0 0 1 90 14" fill="none" stroke="#00c853" strokeWidth="16" strokeLinecap="round" />
//                                                 <line x1="90" y1="82" x2="152" y2="46" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" />
//                                                 <circle cx="90" cy="82" r="6" fill="#333" /><circle cx="90" cy="82" r="3" fill="#ffffff" />
//                                                 <text x="90" y="58" textAnchor="middle" fontSize="13" fontWeight="900" fill="#ff1744" fontFamily="monospace">HIGH</text>
//                                                 <text x="90" y="72" textAnchor="middle" fontSize="11" fontWeight="700" fill="#ff5252" fontFamily="monospace">ΔP</text>
//                                                 <text x="20" y="94" textAnchor="middle" fontSize="8" fill="#00c853" fontFamily="monospace">LOW</text>
//                                                 <text x="160" y="94" textAnchor="middle" fontSize="8" fill="#ff1744" fontFamily="monospace">HIGH</text>
...
//                             <div className="flex flex-col gap-3">
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">2.Verification</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleRdbOcapClick(2, 'Perform wafer visual inspection and re-measure wafer Thickness uniformity.', 3)}>
//                                         Perform wafer visual inspection and re-measure wafer Thickness uniformity. Result: Same as 1st measurement; Troubleshoot tool
//                                     </button>
//                                 </div>
//                                 <div className="border border-orange-500/40 rounded-md p-3.5 bg-orange-500/10">
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => alert('Air pocket detected due to empty resist bottle')}>
//                                         <strong className="text-orange-500">2. Air pocket – Empty resist bottle</strong>
//                                     </button>
//                                 </div>
//                                 <div className="flex-1">
//                                     <img src="/resistbubblebottle.png" alt="Resist Bottle" className="w-full block rounded border border-blue-500/20" />
//                                 </div>
//                             </div>

//                             {/* RIGHT */}
//                             <div className="flex flex-col gap-3">
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5 flex flex-col flex-1">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">4.Actions</div>
//                                     {dpMode === 'high' && (
//                                         <button className="w-full bg-gray-500/10 border border-red-500 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-2"
//                                             onClick={() => handleRdbActionClick('filter', 'Filter Prime initiated — filter ΔP returned to nominal.')}>
//                                             <span className="font-black text-blue-400 mr-1.5">1.</span>
//                                             Replace filter if high ΔP, Filter Prime – Evacuate, Saturate, Pressurize filter to remove microbubbles
//                                         </button>
//                                     )}
//                                     <button className={`w-full bg-gray-500/10 border text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mt-2 ${dpMode === 'normal' ? 'border-green-500' : 'border-red-500'}`}
//                                         onClick={() => handleRdbActionClick('bottle', 'Bottle changed. System purge completed.')}>
//                                         <span className="font-black text-blue-400 mr-1.5">{dpMode === 'high' ? '2.' : '1.'}</span>
//                                         Change to fresh resist bottle; System purge – Dummy dispense 5x cycles
//                                     </button>
...
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">5.Validation</div>
//                                         <div className="flex flex-col sm:flex-row gap-2 items-start">
//                                             <div className="flex flex-col gap-2 flex-1">
//                                                 <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                     onClick={() => {
//                                                         if (rdbOcapStep !== 5) { showRdbFlowError(); return; }
//                                                         alert('Running 3-wafer thickness check.');
//                                                         setRdbValidationClicks(prev => ({ ...prev, thicknessCheck: true }));
//                                                     }}>
//                                                     Run 3 wafer thickness check
//                                                 </button>
//                                                 <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
...
//                                                         alert('Wafer thickness uniformity: 0.8% (spec <1.0%) — returned to baseline. Tool status GREEN (PROD).');
//                                                         setRdbValidationClicks(prev => {
//                                                             const updated = { ...prev, uniformityBaseline: true };
//                                                             if (updated.thicknessCheck && updated.uniformityBaseline) setRdbOcapStep(6);
//                                                             return updated;
//                                                         });
//                                                     }}>
//                                                     Wafer thickness uniformity back to baseline
//                                                 </button>
//                                             </div>
//                                             <div className="min-w-[120px] bg-green-900/30 border border-green-500 rounded p-2 flex flex-col items-center gap-0.5 text-center flex-shrink-0">
//                                                 <div className="text-[8px] font-bold tracking-wide text-green-400 font-mono">THICKNESS UNIFORMITY</div>
//                                                 <div className="text-[11px] font-black tracking-wide text-green-400 font-mono">RETURNS TO &lt;1%</div>
//                                                 <div className="w-4/5 h-px bg-green-500/35 my-0.5" />
//                                                 <div className="text-[8px] font-black tracking-wide text-green-400 font-mono">SYSTEM STATUS: GREEN</div>
//                                             </div>
//                                         </div>
//                                     </div>

//                                     {/* Release */}
//                                     <div className="border-t border-blue-500/15 pt-2.5 mt-2.5">
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2 uppercase border-b border-blue-500/20 pb-1.5">6.Release &amp; Monitor</div>
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleRdbOcapClick(6, 'Release tool for production; Record OCAP data base', 7)}>
//                                             Release tool for production; Record OCAP data base
//                                         </button>
//                                     </div>
//                                 </div>
...
//                 {/* EQUIPMENT TROUBLESHOOTING — FM-005 EBR */}
//                 {activeTab === 'troubleshooting' && fm.id === 'FM-005' && (
//                     <div className="w-full">
//                         <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg">
//                             {/* LEFT */}
...
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">1.Containment &amp; Disposition</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleEbrOcapClick(1, 'Lock out / tag out EBR module. Hold lot.', 2)}>
//                                         Perform Tool LOTO; Hold lot, Strip &amp; rework wafers
//                                     </button>
//                                 </div>
...
//                                         {(['clog', 'misalign'] as const).map(mode => (
//                                             <label key={mode} className="flex flex-col items-center justify-center gap-2 text-center min-h-16 bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-2.5 rounded text-sm font-sans cursor-pointer transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400">
//                                                 <input type="radio" name="ebrRootMode" checked={ebrRootMode === mode} onChange={() => setEbrRootMode(mode)} />
//                                                 {mode === 'clog' ? 'EBR Nozzle Clog' : 'EBR Arm Misalignment'}
//                                             </label>
//                                         ))}
//                                     </div>
//                                     {ebrRootMode === 'clog' ? (
//                                         <>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-3"
//                                                 onClick={() => handleEbrOcapClick(3, 'Root cause completed: Solvent line pressure test confirms flow drop.', 4)}>
//                                                 Solvent line pressure test shows Flow Drop
//                                             </button>
//                                             <div className="grid grid-cols-2 gap-2">
//                                                 <Image src="/root couse.png" alt="Root cause" width={260} height={150} className="w-full h-24 object-contain rounded" />
//                                                 <Image src="/clogdeffect3rdmodule.png" alt="Clog defect" width={260} height={150} className="w-full h-24 object-contain rounded" />
//                                             </div>
//                                         </>
//                                     ) : (
//                                         <>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-3"
//                                                 onClick={() => handleEbrOcapClick(3, 'Root cause completed: Misalignment test confirms positional deviation.', 4)}>
//                                                 Positional Deviation
//                                             </button>
//                                             <div className="grid grid-cols-2 gap-2">
//                                                 <Image src="/misalignment2.png" alt="Misalignment" width={260} height={150} className="w-full h-24 object-contain rounded" />
//                                                 <Image src="/misalignmentsprey.png" alt="Offset stream" width={260} height={150} className="w-full h-24 object-contain rounded" />
//                                             </div>
//                                         </>
//                                     )}
//                                 </div>
...
//                                 <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5">
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">2.Verification</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-2"
//                                         onClick={() => handleEbrOcapClick(2, 'Perform wafer visual inspection and re-measure EBR width.', 3)}>
//                                         Perform wafer visual inspection and re-measure wafer EBR width.
//                                     </button>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleEbrOcapClick(2, 'Run nozzle XY positional test. Confirm deviation in X or Y axis.', 3)}>
//                                         Perform misalignment test — Positional deviation
//                                     </button>
//                                 </div>
//                                 <div className="border-2 border-gray-500 rounded-lg p-2.5 bg-white">
//                                     <Image src="/Capture.PNG" alt="Verification Analysis" width={500} height={300} className="w-full h-auto object-contain" />
//                                 </div>
//                             </div>
...
//                                     {ebrRootMode === 'clog' ? (
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleEbrOcapClick(4, 'Replace the clogged EBR nozzle tip insert.', 5)}>
//                                             <span className="font-black text-blue-400 mr-1.5">1.</span> Replace EBR nozzle tip
//                                         </button>
//                                     ) : (
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleEbrOcapClick(4, 'Re-teach nozzle XY position to target 148.5 mm.', 5)}>
//                                             <span className="font-black text-blue-400 mr-1.5">1.</span> Re-calibrate EBR nozzle arm to position the spray
//                                         </button>
//                                     )}
//                                     <div className="text-xs leading-relaxed text-gray-500 dark:text-gray-500 border-l border-blue-500/15 pl-3 mt-3">
//                                         <strong className="block text-gray-800 dark:text-gray-200 mb-1 text-sm">Details of actions:</strong>
//                                         <p className="text-sm text-gray-700 dark:text-gray-300">Replace relevant hardware element or perform re-calibration depending on the scenario observed.</p>
//                                     </div>

//                                     <div className="flex-1" />

//                                     <div className="border-t border-blue-500/15 pt-3 mt-2">
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2 uppercase border-b border-blue-500/20 pb-1.5">5.Validation</div>
//                                         <div className="flex flex-col sm:flex-row gap-2 items-start">
//                                             <div className="flex flex-col gap-2 flex-1">
//                                                 <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                     onClick={() => {
//                                                         if (ebrOcapStep !== 5) { showEbrFlowError(); return; }
//                                                         alert('Run EBR cycle on dummy wafer. Confirm flow 15.0 ml/min.');
//                                                         setEbrValidationClicks(prev => ({ ...prev, dummyWafer: true }));
//                                                     }}>
//                                                     Run EBR width dummy wafer
//                                                 </button>
...
//                                                     onClick={() => {
//                                                         if (ebrOcapStep !== 5) { showEbrFlowError(); return; }
//                                                         alert('EBR removal boundary confirmed. Tool: GREEN (PROD).');
//                                                         setEbrValidationClicks(prev => {
//                                                             const updated = { ...prev, baseline: true };
//                                                             if (updated.dummyWafer && updated.baseline) setEbrOcapStep(6);
//                                                             return updated;
//                                                         });
//                                                     }}>
//                                                     EBR width back to baseline
...
//                                                 <Image src="/ebrcutline.png" alt="EBR Cut-line" width={300} height={160} className="w-full h-full object-cover rounded" />
//                                             </div>
//                                         </div>
//                                     </div>

//                                     <div className="border-t border-blue-500/15 pt-2.5 mt-2.5">
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-1.5 uppercase">6.Release &amp; Monitor</div>
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleEbrOcapClick(6, 'Release tool for production.', 7)}>
//                                             Release tool for production; Record OCAP data base
//                                         </button>
//                                     </div>
//                                 </div>
...
//                 {/* EQUIPMENT TROUBLESHOOTING — FM-004 Exhaust Fan */}
//                 {activeTab === 'troubleshooting' && fm.id === 'FM-004' && (
//                     <div className="w-full">
//                         <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg">
//                             {/* LEFT */}
...
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">1.Containment &amp; Disposition</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleExfOcapClick(1, 'Tool LOTO applied. Hard Lock confirmed.', 2)}>
//                                         Perform Tool LOTO; Hold lot, Strip &amp; rework wafers
//                                     </button>
//                                 </div>
...
//                                         {(['grates', 'motor'] as const).map(cause => (
//                                             <label key={cause} className="min-h-16 p-2 flex flex-col items-center justify-center gap-1.5 text-center leading-tight text-sm bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 rounded cursor-pointer transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400">
//                                                 <input type="radio" name="exfRootCause" checked={exfRootCause === cause}
//                                                     onChange={() => {
//                                                         setExfRootCause(cause);
//                                                         handleExfOcapClick(3, cause === 'grates' ? 'Root cause: Dried Polymer in Exhaust Grates.' : 'Root cause: Exhaust Fan Motor not working.', 4);
//                                                     }} />
//                                                 <span>{cause === 'grates' ? 'Dried Polymer / Photoresist build up in Exhaust Grates' : 'Exhaust Fan Motor not working'}</span>
//                                             </label>
//                                         ))}
//                                     </div>
//                                     {exfRootCause && (
//                                         <div className="w-full flex justify-center">
//                                             <div className="w-full max-w-xs h-40 rounded overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
//                                                 <Image src={exfRootCause === 'grates' ? '/gratesmodule1.png' : '/fanrpm4module.png'} alt="Root Cause" width={340} height={175} className="w-full h-full object-contain rounded" />
//                                             </div>
//                                         </div>
//                                     )}
//                                 </div>
...
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">2.Verification</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleExfOcapClick(2, 'Wafer thickness check complete. Airflow confirmed at 0.10 m/s.', 3)}>
//                                         Perform wafer thickness check and re-measure wafer Thickness uniformity.
//                                     </button>
//                                 </div>
//                             </div>
...
//                                         {exfRootCause === 'grates' && (
//                                             <button className="bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-3 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => handleExfOcapClick(4, 'Cleaning exhaust grates — removing dried polymer. Airflow restored.', 5)}>
//                                                 Clean Exhaust Grates
//                                             </button>
//                                         )}
//                                         {exfRootCause === 'motor' && (
//                                             <button className="bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-3 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => handleExfOcapClick(4, 'Replacing exhaust fan motor — Fan RPM returning to nominal.', 5)}>
//                                                 Replace Exhaust Fan Motor
//                                             </button>
//                                         )}
//                                     </div>
//                                     <div className="text-xs leading-relaxed text-gray-500 dark:text-gray-500 border-l border-blue-500/15 pl-3 mb-2.5">
//                                         <strong className="block text-gray-800 dark:text-gray-200 mb-1 text-sm">5.Details of actions:</strong>
//                                         <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">Clean parts or replace relevant hardware element depending on the scenario observed.</p>
//                                     </div>
//                                     <div className="flex-1" />
...
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => {
//                                                     if (exfOcapStep !== 5) { showExfFlowError(); return; }
//                                                     alert('Running 3-wafer thickness check.');
//                                                     setExfValidationClicks(prev => ({ ...prev, thicknessCheck: true }));
//                                                 }}>
//                                                 Run 3 wafer thickness check and dry monitor defect map
//                                             </button>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => {
//                                                     if (exfOcapStep !== 5) { showExfFlowError(); return; }
//                                                     alert('Wafer thickness uniformity: 0.6% (within spec). Tool status GREEN (PROD).');
//                                                     setExfValidationClicks(prev => {
//                                                         const updated = { ...prev, defectMap: true };
//                                                         if (updated.thicknessCheck && updated.defectMap) setExfOcapStep(6);
//                                                         return updated;
//                                                     });
//                                                 }}>
//                                                 Wafer thickness uniformity back to baseline
...
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-1.5 uppercase">6.Release &amp; Monitor</div>
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleExfOcapClick(6, 'Tool released for production. Hard Lock lifted.', 7)}>
//                                             Release tool for production; Record OCAP data base
//                                         </button>
//                                     </div>
//                                 </div>
...
//                 {/* EQUIPMENT TROUBLESHOOTING — FM-003 Developer Concentration */}
//                 {activeTab === 'troubleshooting' && fm.id === 'FM-003' && (
//                     <div className="w-full">
//                         <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-lg">
//                             {/* LEFT */}
...
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">1.Containment &amp; Disposition</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                         onClick={() => handleDevOcapClick(1, 'Tool LOTO applied. Lot on HOLD.', 2)}>
//                                         Perform Tool LOTO; Hold lot, Strip &amp; rework wafers
//                                     </button>
//                                 </div>
...
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">3.Root cause</div>
//                                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
//                                         {(['diwater', 'chiller'] as const).map(cause => (
//                                             <label key={cause} className="flex flex-col items-center gap-2 bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400">
//                                                 <input type="radio" name="devRootCause" checked={devRootCause === cause}
//                                                     onChange={() => {
//                                                         setDevRootCause(cause);
//                                                         handleDevOcapClick(3, cause === 'diwater' ? '[CDS LOG — ERROR] DI Water Supply interruption.' : '[HEAT EXCHANGER STATUS: CRITICAL] Chiller not working.', 4);
//                                                     }} />
//                                                 {cause === 'diwater' ? 'DI Water Supply interruption' : 'Heat Exchanger Chiller not working'}
//                                             </label>
//                                         ))}
//                                     </div>
//                                     {devRootCause && (
//                                         <div className="flex justify-center mb-3">
//                                             <div className="w-full border border-gray-200 dark:border-gray-700 rounded bg-white p-1">
//                                                 <Image src={devRootCause === 'diwater' ? '/cdsunitlast.png' : '/chillplatelast.png'} alt="Developer Root Cause" width={420} height={220} className="w-full h-48 object-contain rounded" />
//                                             </div>
//                                         </div>
//                                     )}
//                                     <div className="text-xs text-gray-500 dark:text-gray-500 mt-1">CDS — Chemical dispense system</div>
//                                 </div>
//                             </div>
...
//                                     <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2.5 uppercase border-b border-blue-500/20 pb-1.5">2.Verification</div>
//                                     <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-3"
//                                         onClick={() => handleDevOcapClick(2, 'Developer chemical sampling initiated. Manual titration result: 2.48% TMAH Normality — HIGH SPEC confirmed.', 3)}>
//                                         Test developer chemical sampling
//                                     </button>
//                                     <div>
//                                         <Image src="/PERFORMimglastmodule.png" alt="Perform Manual Titration" width={420} height={220} className="w-full h-auto object-contain rounded" />
//                                     </div>
//                                 </div>
//                             </div>
...
//                                         <>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-2"
//                                                 onClick={() => handleDevOcapClick(4, 'Restoring DI water flow. TMAH normality returning to 2.38%.', 5)}>
//                                                 Restore DI Water flow
//                                             </button>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => handleDevOcapClick(4, 'Flushing developer line. Normality verified at 2.38%.', 5)}>
//                                                 Flush Developer Line
//                                             </button>
//                                         </>
//                                     )}
...
//                                         <>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mb-2"
//                                                 onClick={() => handleDevOcapClick(4, 'Fixing heat exchanger — Developer temperature returning to 23.0°C.', 5)}>
//                                                 Fix Heat Exchanger
//                                             </button>
//                                             <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                                 onClick={() => handleDevOcapClick(5, 'Flushing developer line. Normality verified at 2.38%.', 6)}>
//                                                 Flush Developer Line
//                                             </button>
//                                         </>
//                                     )}
//                                     <div className="text-xs leading-relaxed text-gray-500 dark:text-gray-500 border-l border-blue-500/15 pl-3 my-2.5">
//                                         <strong className="block text-gray-800 dark:text-gray-200 mb-1 text-sm">5. Details of actions:</strong>
//                                         <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">Perform relevant actions #1 or #2 depending on the scenario observed and then flush developer line</p>
//                                     </div>
//                                     <div className="flex-1" />
...
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 mb-2 uppercase border-b border-blue-500/20 pb-1.5">5. Validation</div>
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
//                                             onClick={() => handleDevOcapClick(5, 'Verify wafer CD: CD-SEM remeasurement complete. ADI inspection — No abnormalities found.', 6)}>
//                                             Verify wafer CD and ADI inspection for pitting defects.
//                                         </button>
//                                     </div>

//                                     <div className="border-t border-blue-500/15 pt-2.5 mt-2.5">
//                                         <div className="text-lg font-bold tracking-wide text-blue-600 dark:text-blue-400 uppercase mb-1.5">6.Release &amp; Monitor</div>
//                                         <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400 mt-2"
//                                             onClick={() => handleDevOcapClick(6, 'Tool released for production.', 7)}>
//                                             Release tool for production; Record OCAP data base
//                                         </button>
//                                     </div>
//                                 </div>
...
//                 {activeTab === 'ocap' && (
//                     <div className="w-full">
//                         <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex flex-col gap-0">
...
//                                 {fm.ocapFlow.map((step, idx) => (
//                                     <div key={idx} className={`flex gap-4 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-3 pr-4 transition-all duration-200 items-start ${step.state === 'active' ? 'border-l-4 border-blue-500 bg-blue-500/5' : step.state === 'completed' ? 'border-l-4 border-green-500 opacity-75' : ''}`}>
//                                         <div className="w-8 h-8 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center font-mono text-[13px] font-bold text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5">{idx + 1}</div>
...
//                                             {idx === 0 && (
//                                                 <button
//                                                     className={`self-start bg-blue-500/10 border border-blue-500 text-blue-600 dark:text-blue-400 rounded px-4 py-1.5 text-[11px] font-mono cursor-pointer transition-all duration-200 hover:bg-blue-500/25 ${step.btnClass === 'rca' ? 'border-yellow-500 text-yellow-500 bg-yellow-500/10' : step.btnClass === 'recovery' ? 'border-green-500 text-green-500 bg-green-500/10' : step.btnClass === 'disposition' ? 'border-red-500 text-red-500 bg-red-500/10' : ''}`}
//                                                     onClick={() => alert(step.alertMsg)}
//                                                 >
//                                                     {step.btnLabel}
//                                                 </button>
...
//                                 <div className="font-mono text-[11px] tracking-wider text-gray-500 dark:text-gray-500 mb-3">OCAP CHECKLIST</div>
//                                 <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
//                                     {fm.ocap.map((item, idx) => (
//                                         <div key={idx} className="flex items-start gap-2.5 p-2.5 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded transition-all duration-200 hover:border-blue-500">
//                                             <input type="checkbox" id={`ck-${currentFM}-${idx}`} className="w-4 h-4 cursor-pointer accent-green-500 mt-0.5 flex-shrink-0" />
//                                             <label htmlFor={`ck-${currentFM}-${idx}`} className="text-xs text-gray-600 dark:text-gray-400 cursor-pointer leading-relaxed">{item}</label>
//                                         </div>
//                                     ))}
//                                 </div>
//                             </div>
...
//                                 {pebSc && (
//                                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 min-h-[210px] flex flex-col">
//                                         <div className="font-mono text-[9px] font-bold tracking-wider text-gray-500 dark:text-gray-500 mb-1.5">⬡ TEMP — RTM (°C) Real Time Monitoring</div>
//                                         <div className="flex flex-wrap gap-3 mb-2 text-xs">
//                                             {[{ id: 1, color: '#3a3232' }, { id: 2, color: '#4ecdc4' }, { id: 3, color: '#ccccaa' }, { id: 4, color: '#95e77e' }, { id: 5, color: '#a78bfa' }].map(zone => {
//                                                 const isActive = zone.id === 4;
//                                                 return (
//                                                     <div key={zone.id} className="flex items-center gap-1.5">
//                                                         <div className="w-5 h-0.5" style={{ background: isActive ? '#ff0000' : zone.color }}></div>
//                                                         <span className={isActive ? 'text-red-600 font-bold text-xs' : 'text-black dark:text-white text-xs'}>Zone {zone.id}</span>
//                                                     </div>
//                                                 );
//                                             })}
//                                         </div>
//                                         <div className="flex justify-between mb-1 text-[11px] text-gray-500 dark:text-gray-500">
//                                             <span>UCL: 110.1°C</span><span>LCL: 109.9°C</span>
//                                         </div>
//                                         <canvas ref={rtmCanvasRef} className="w-full block" height="150" />
//                                     </div>
//                                 )}

//                                 {pebSc && (
//                                     <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 min-h-[210px] flex flex-col">
//                                         <div className="font-mono text-[9px] font-bold tracking-wider text-gray-500 dark:text-gray-500 mb-1.5">⬡ HEATER DUTY CYCLE (%) RTM</div>
//                                         <div className="flex flex-wrap gap-3 mb-2 text-xs">
//                                             {[{ id: 1, color: '#3c3434' }, { id: 2, color: '#4ecdc4' }, { id: 3, color: '#ffe66d' }, { id: 4, color: '#95e77e' }, { id: 5, color: '#a78bfa' }].map(zone => {
//                                                 const isActive = zone.id === 4;
//                                                 return (
//                                                     <div key={zone.id} className="flex items-center gap-1.5">
//                                                         <div className="w-5 h-0.5" style={{ background: isActive ? '#ff0000' : zone.color }}></div>
...
//                                             <span>UCL: 110.1°C</span><span>LCL: 109.9°C</span>
//                                         </div>
//                                         <canvas ref={dutyCanvasRef} className="w-full block" height="150" />
//                                     </div>
//                                 )}

//                                 <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 min-h-[210px] flex flex-col">
//                                     <div className="flex items-center justify-between flex-wrap gap-1 font-mono text-[9px] font-bold tracking-wider text-gray-500 dark:text-gray-500 mb-1.5">
//                                         <span>⬡ OFFLINE CD-SEM, SPC Chart</span>
//                                         {pebSc && <span className="font-mono text-[8px] px-1.5 py-0.5 rounded bg-red-500/15 text-red-600 dark:text-red-500 border border-red-500/30">{pebScenario === 2 ? 'OOS MIXTURE' : 'DOWNWARD SHIFT'}</span>}
//                                     </div>
//                                     {pebSc ? (
//                                         <img src={pebScenario === 2 ? '/scenario2-cdoffline1.png' : '/scenarion1graph.png'} alt="CD-SEM chart" className="w-full h-auto object-contain rounded" />
//                                     ) : (
//                                         <div className="flex-1 flex items-center justify-center text-[11px] font-mono text-gray-500 text-center p-5">Select PEB Scenario to view CD-SEM data</div>
//                                     )}
//                                 </div>
...
//                                     <div className="flex items-center justify-between flex-wrap gap-1 font-mono text-[9px] font-bold tracking-wider text-gray-500 dark:text-gray-500 mb-1.5">
//                                         <span>⬡ CD UNIFORMITY, SPC Chart</span>
//                                         {pebSc && <span className="font-mono text-[8px] px-1.5 py-0.5 rounded bg-orange-500/15 text-orange-500 border border-orange-500/30">{pebScenario === 2 ? 'HIGH VARIABILITY' : 'SPIKING'}</span>}
//                                     </div>
//                                     {pebSc ? (
//                                         <img src={pebScenario === 2 ? '/scenario2-cduniform2.png' : '/scenario13-cduniform.png'} alt="CD Uniformity chart" className="w-full h-auto object-contain rounded" />
//                                     ) : (
//                                         <div className="flex-1 flex items-center justify-center text-[11px] font-mono text-gray-500 text-center p-5">Select PEB Scenario to view CD Uniformity data</div>
//                                     )}
//                                 </div>
//                             </div>

//                             {/* Wafer Map */}
//                             <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col justify-start">
//                                 <div className="flex items-center justify-between flex-wrap gap-1 font-mono text-[9px] font-bold tracking-wider text-gray-500 dark:text-gray-500 mb-1.5">
//                                     <span>⬡ 300mm WAFER CD MAP</span>
//                                     {pebSc && (
//                                         <span className={`font-mono text-[8px] px-1.5 py-0.5 rounded ${pebScenario === 3 ? 'bg-orange-500/15 text-orange-500 border border-orange-500/30' : 'bg-red-500/15 text-red-600 dark:text-red-500 border border-red-500/30'}`}>
//                                             {pebScenario === 1 ? 'ZONE DROP' : pebScenario === 2 ? 'ERRATIC' : 'IDENTICAL TO SC1'}
//                                         </span>
//                                     )}
//                                 </div>
//                                 <div className="relative w-full h-60">
//                                     <img src={pebScenario === 2 ? "/waffermapscenario2.png" : "/wafercd.png"} alt="Wafer CD Map" className="w-full h-full object-contain block rounded" />
//                                 </div>
//                                 <div className="mt-2 border-t border-gray-200 dark:border-gray-700 pt-2 flex flex-col gap-1">
//                                     {[
//                                         ['Center CD', '22nm'],
//                                         ['Failure Zone', 'Zone 4'],
//                                         ['Thermal Pattern', pebScenario === 2 ? 'Erratic Thermal Noise' : 'Cold Ring Drift'],
//                                         ['Process Impact', pebScenario === 2 ? 'Random CD Variation / Scrap' : 'CD Shift / Yield Loss'],
//                                         ['Diagnosis', pebScenario === 2 ? 'Broken Thermocouple Sensor' : 'Heater / SSR Failure'],
//                                     ].map(([label, value]) => (
//                                         <div key={label} className="flex justify-between items-center text-xs font-mono text-gray-600 dark:text-gray-400 py-0.5">
//                                             <span>{label}</span>
//                                             <strong className="text-blue-600 dark:text-blue-400 text-xs">{value}</strong>
//                                         </div>
//                                     ))}
//                                 </div>
//                             </div>
...
//     const makeDuty = (seed: number, base: number) => {
//         const rand = seededRand(seed);
//         return Array.from({ length: 501 }, () => Math.min(65, Math.max(35, base + (rand() - 0.5) * 8)));
//     };
//     const dz1 = makeDuty(101, 50);
//     const dz2 = makeDuty(102, 48);
//     const dz3 = makeDuty(103, 46);
//     const dz5 = makeDuty(105, 52);
//     const dz4 = Array.from({ length: 501 }, (_, i) => {
//         const rand = seededRand(203 + i);
//         if (i < dutyJump) {
//             const zigzag = Math.sin(i * 1.5) * 3 + Math.sin(i * 3.2) * 2 + Math.cos(i * 2.1) * 2;
//             return Math.min(55, Math.max(38, 46 + zigzag + (rand() - 0.5) * 4));
...
//     const makeDuty = (seed: number, base: number) => {
//         const rand = seededRand(seed);
//         return Array.from({ length: 501 }, () => Math.min(50, Math.max(28, base + (rand() - 0.5) * 6)));
//     };
//     const dz1 = makeDuty(101, 38);
//     const dz2 = makeDuty(102, 36);
//     const dz3 = makeDuty(103, 34);
...
//     const dz4: number[] = [];
//     const dutyPoints: [number, number][] = [
//         [0, 40], [199, 42], [200, 42], [203, 2], [205, 42], [207, 4], [209, 42],
//         [211, 2], [213, 102], [215, 42], [217, 3], [219, 42], [221, 4], [222, 103], [224, 42],
//         [226, 2], [228, 42], [230, 3], [231, 104], [233, 42], [235, 2], [237, 42],
//         [239, 4], [240, 105], [242, 42], [244, 2], [246, 42], [248, 104], [250, 42],
//         [252, 2], [255, 42], [256, 96], [258, 42], [260, 2], [263, 42], [265, 97], [267, 42],
//         [269, 2], [272, 42], [274, 96], [276, 42], [278, 2], [281, 42], [283, 97], [285, 42],
//         [287, 2], [290, 42], [292, 96], [294, 42], [296, 2], [299, 42], [301, 95], [303, 42],
//         [305, 2], [309, 42], [311, 96], [313, 42], [315, 2], [319, 42], [321, 97], [323, 42],
//         [325, 2], [329, 42], [331, 95], [333, 42], [335, 2], [339, 42], [341, 96], [343, 42],
//         [345, 2], [349, 42], [351, 97], [353, 42], [355, 2], [359, 42], [361, 95], [363, 42],
//         [365, 2], [369, 42], [371, 96], [373, 42], [375, 2], [379, 42], [381, 96], [383, 42],
//         [385, 2], [389, 42], [391, 95], [393, 42], [395, 2], [399, 42], [401, 97], [403, 42],
//         [405, 2], [409, 42], [411, 96], [413, 42], [415, 2], [419, 42], [421, 95], [423, 42],
//         [425, 2], [429, 42], [431, 96], [433, 42], [435, 2], [439, 42], [441, 97], [443, 42],
//         [445, 2], [449, 42], [451, 96], [453, 42], [455, 2], [459, 42], [461, 95], [463, 42],
//         [465, 2], [469, 42], [471, 97], [473, 42], [475, 2], [479, 42], [481, 96], [483, 42],
//         [485, 2], [489, 42], [491, 95], [493, 42], [495, 2], [499, 42], [500, 42],
//     ];
//     for (let i = 0; i < 501; i++) {
//         let lo = dutyPoints[0];
//         let hi = dutyPoints[dutyPoints.length - 1];
//         for (let j = 0; j < dutyPoints.length - 1; j++) {
//             if (dutyPoints[j][0] <= i && dutyPoints[j + 1][0] >= i) { lo = dutyPoints[j]; hi = dutyPoints[j + 1]; break; }
//         }
//         const t = hi[0] === lo[0] ? 0 : (i - lo[0]) / (hi[0] - lo[0]);
//         const val = lo[1] + t * (hi[1] - lo[1]);
//         const noise = (seededRand(203 + i * 3)() - 0.5) * 2;
...
//         return Array.from({ length: CHART_N }, () => 110 + (r() - 0.5) * 0.4);
//     };
//     const z1 = makeFlat110(11); const z2 = makeFlat110(22); const z3 = makeFlat110(33); const z5 = makeFlat110(55);
//     const z4: number[] = new Array(CHART_N).fill(120);
//     const rP0 = seededRand(9901);
//     for (let i = 0; i <= 200; i++) z4[i] = 120 + (rP0() - 0.5) * 5;
//     const rH = seededRand(8821); const rPos = seededRand(3317); const rDir = seededRand(6643); const rW = seededRand(2291); const rNs = seededRand(5577);
//     const spikes: Array<[number, number, boolean]> = [];
//     let x = 202;
//     while (x < 250) { const p = (x - 200) / 50; const amp = 30 + p * 70 + rH() * 30; spikes.push([Math.round(x), amp, rDir() < 0.50]); x += 3 + Math.round(rPos() * 5); }
//     x = 252;
//     while (x < 330) { const p = (x - 250) / 80; const amp = 80 + p * 120 + rH() * 50; spikes.push([Math.round(x), Math.min(380, amp), rDir() < 0.50]); x += 3 + Math.round(rPos() * 4); }
//     x = 332;
//     while (x < 420) { const p = (x - 330) / 90; const amp = 170 + p * 150 + rH() * 55; spikes.push([Math.round(x), Math.min(380, amp), rDir() < 0.50]); x += 2 + Math.round(rPos() * 4); }
//     x = 422;
//     while (x < 500) { const p = (x - 420) / 80; const amp = 280 + p * 100 + rH() * 35; spikes.push([Math.round(x), Math.min(380, amp), rDir() < 0.50]); x += 2 + Math.round(rPos() * 3); }
//     for (const [px, amp, goUp] of spikes) {
//         const peak = goUp ? 120 + amp : Math.max(23, 120 - amp);
//         const hw = rW() < 0.45 ? 1 : 2;
//         for (let d = hw; d >= 1; d--) { const idx = px - d; if (idx >= 200 && idx < CHART_N) { const frac = (hw - d + 1) / (hw + 1); const val = 120 + frac * (peak - 120); if (Math.abs(val - 120) > Math.abs(z4[idx] - 120)) z4[idx] = val; } }
//         if (px >= 200 && px < CHART_N) { if (Math.abs(peak - 120) > Math.abs(z4[px] - 120)) z4[px] = peak; }
//         for (let d = 1; d <= hw; d++) { const idx = px + d; if (idx < CHART_N) { const frac = (hw - d + 1) / (hw + 1); const val = 120 + frac * (peak - 120); if (Math.abs(val - 120) > Math.abs(z4[idx] - 120)) z4[idx] = val; } }
//     }
//     for (let i = 200; i < CHART_N; i++) { if (Math.abs(z4[i] - 120) < 0.5) z4[i] = 120 + (rNs() - 0.5) * 2; }
//     return [z1, z2, z3, z4, z5];
// }
...
//     canvas: HTMLCanvasElement,
//     datasets: { data: number[]; color: string }[],
//     yMin: number, yMax: number, yTickCount: number,
//     yTickFmt: (v: number) => string,
//     bgColor: string,
//     annotationFn?: (ctx: CanvasRenderingContext2D, sx: (i: number) => number, sy: (v: number) => number, W: number, H: number, pad: { l: number; t: number; r: number; b: number }) => void
// ) {
//     const rect = canvas.getBoundingClientRect();
//     if (rect.width === 0) return;
//     canvas.width = rect.width;
//     canvas.height = 150;
//     const W = rect.width; const H = 150;
//     const pad = { l: 56, t: 12, r: 16, b: 24 };
...
//         const v = yMin + (yMax - yMin) * (i / yTickCount);
//         const y = sy(v);
//         ctx.beginPath(); ctx.strokeStyle = 'rgba(0,0,0,0.07)'; ctx.lineWidth = 0.8; ctx.moveTo(pad.l, y); ctx.lineTo(W - pad.r, y); ctx.stroke();
//     }
//     [0, 100, 200, 300, 400, 500].forEach(xVal => {
//         const xi = Math.round((xVal / 500) * (n - 1));
//         const x = sx(xi);
//         ctx.beginPath(); ctx.strokeStyle = 'rgba(0,0,0,0.07)'; ctx.lineWidth = 0.8; ctx.moveTo(x, pad.t); ctx.lineTo(x, H - pad.b); ctx.stroke();
//     });
//     ctx.save();
//     ctx.beginPath(); ctx.rect(pad.l, pad.t, gW, gH); ctx.clip();
//     datasets.forEach(({ data, color }) => {
//         ctx.beginPath(); ctx.strokeStyle = color; ctx.lineWidth = 1.6; ctx.lineJoin = 'round'; ctx.lineCap = 'round';
//         data.forEach((v, i) => { const clamped = Math.max(yMin, Math.min(yMax, v)); i === 0 ? ctx.moveTo(sx(i), sy(clamped)) : ctx.lineTo(sx(i), sy(clamped)); });
//         ctx.stroke();
//     });
//     ctx.restore();
//     ctx.font = '9px "Share Tech Mono", monospace'; ctx.textAlign = 'right'; ctx.textBaseline = 'middle'; ctx.fillStyle = '#666666';
//     for (let i = 0; i <= yTickCount; i++) { const v = yMin + (yMax - yMin) * (i / yTickCount); ctx.fillText(yTickFmt(v), pad.l - 8, sy(v)); }
//     ctx.textAlign = 'center';
//     [0, 100, 200, 300, 400, 500].forEach(xVal => { const xi = Math.round((xVal / 500) * (n - 1)); ctx.fillText(String(xVal), sx(xi), H - pad.b + 12); });
//     ctx.strokeStyle = '#cccccc'; ctx.lineWidth = 0.8;
//     ctx.beginPath(); ctx.moveTo(pad.l, pad.t); ctx.lineTo(pad.l, H - pad.b); ctx.lineTo(W - pad.r, H - pad.b); ctx.stroke();
//     if (annotationFn) annotationFn(ctx, sx, sy, W, H, pad);
// }

// function drawWaferCDMap(canvas: HTMLCanvasElement, scenario: PEBScenario, isDark: boolean) {
//     const W = canvas.offsetWidth || 260; const H = canvas.offsetHeight || 260;
//     canvas.width = W; canvas.height = H;
//     const ctx = canvas.getContext('2d')!;
//     ctx.clearRect(0, 0, W, H);
//     const bg = isDark ? '#111927' : '#f5f8ff';
//     ctx.fillStyle = bg; ctx.fillRect(0, 0, W, H);
//     const cx = W / 2; const cy = H / 2 + 8; const R = Math.min(W, H) * 0.38;
//     if (!scenario) {
//         const grad = ctx.createRadialGradient(cx, cy, 0, cx, cy, R);
//         grad.addColorStop(0, isDark ? '#1a2a40' : '#dce8f5'); grad.addColorStop(1, isDark ? '#0d1a2a' : '#c8ddf0');
//         ctx.beginPath(); ctx.arc(cx, cy, R, 0, Math.PI * 2); ctx.fillStyle = grad; ctx.fill();
//         ctx.strokeStyle = isDark ? 'rgba(0,229,255,0.3)' : 'rgba(0,100,200,0.3)'; ctx.lineWidth = 1.5; ctx.stroke();
//         ctx.fillStyle = isDark ? '#4a6a8a' : '#5a7a9a'; ctx.font = '10px "Share Tech Mono", monospace'; ctx.textAlign = 'center';
//         ctx.fillText('SELECT SCENARIO', cx, cy - 6); ctx.fillText('TO VIEW MAP', cx, cy + 10);
//         return;
//     }
//     const scData = getPEBScenarioData(scenario)!; const mapType = scData.waferMapType;
//     const stops = mapType === 'tc'
//         ? ['#0000ff', '#0066ff', '#00aaff', '#00ffee', '#00ff88', '#aaff00', '#ffee00', '#ff8800', '#ff2200', '#cc0000']
//         : ['#0000aa', '#0044ff', '#00aaff', '#00eeff', '#00ff88', '#88ff00', '#ffcc00', '#ff6600', '#ff2200', '#aa0000'];
//     const getColor = (t: number) => stops[Math.min(stops.length - 1, Math.floor(t * (stops.length - 1)))];
//     const rings = 8;
//     for (let r = rings; r >= 0; r--) {
//         const frac = r / rings; const radius = frac * R;
//         let cdVal = mapType === 'tc' ? 22 + Math.sin(r * 2.1) * 1.8 + Math.cos(r * 1.3) * 1.2 : 22 - (frac * frac) * 3.5 + 0.1;
//         const t = Math.max(0, Math.min(1, (cdVal - 19) / 6));
//         ctx.beginPath(); ctx.arc(cx, cy, radius, 0, Math.PI * 2); ctx.fillStyle = getColor(t); ctx.fill();
//     }
//     if (mapType === 'tc') {
//         for (let i = 0; i < 8; i++) {
//             const angle = (i / 8) * Math.PI * 2; const frac = 0.5 + Math.sin(i * 1.7) * 0.3;
//             ctx.save(); ctx.globalAlpha = 0.4; ctx.strokeStyle = getColor(frac); ctx.lineWidth = 1.5;
//             ctx.beginPath(); ctx.moveTo(cx, cy); ctx.lineTo(cx + Math.cos(angle) * R, cy + Math.sin(angle) * R); ctx.stroke(); ctx.restore();
//         }
//     }
//     ctx.beginPath(); ctx.arc(cx, cy, R, 0, Math.PI * 2); ctx.strokeStyle = 'rgba(255,255,255,0.6)'; ctx.lineWidth = 2; ctx.stroke();
//     ctx.beginPath(); ctx.arc(cx, cy + R - 4, 5, 0, Math.PI * 2); ctx.fillStyle = bg; ctx.fill();
//     const zones = ['Zone 1', 'Zone 2', 'Zone 3', 'Zone 4', 'Zone 5'];
//     const zoneR = [R * 0.12, R * 0.28, R * 0.48, R * 0.68, R * 0.87];
//     ctx.font = `${Math.max(7, R * 0.07)}px "Share Tech Mono", monospace`; ctx.textAlign = 'center'; ctx.fillStyle = 'rgba(255,255,255,0.85)';
//     zoneR.forEach((zr, i) => ctx.fillText(zones[i], cx, cy - zr + 4));
//     ctx.font = `bold ${Math.max(9, R * 0.1)}px "Share Tech Mono", monospace`; ctx.fillStyle = '#ffffff'; ctx.textAlign = 'center';
//     ctx.fillText('Center', cx, cy + 4); ctx.font = `${Math.max(8, R * 0.085)}px "Share Tech Mono", monospace`; ctx.fillText('(22nm)', cx, cy + 16);
//     const barX = cx + R + 10; const barY = cy - R * 0.8; const barH = R * 1.6; const barW = 10;
//     const barGrad = ctx.createLinearGradient(0, barY, 0, barY + barH);
//     barGrad.addColorStop(0, '#aa0000'); barGrad.addColorStop(0.25, '#ff6600'); barGrad.addColorStop(0.5, '#ffee00'); barGrad.addColorStop(0.75, '#00aaff'); barGrad.addColorStop(1, '#0000aa');
//     ctx.fillStyle = barGrad; ctx.fillRect(barX, barY, barW, barH);
//     ctx.strokeStyle = 'rgba(255,255,255,0.4)'; ctx.lineWidth = 0.5; ctx.strokeRect(barX, barY, barW, barH);
//     ctx.font = `${Math.max(7, R * 0.07)}px "Share Tech Mono", monospace`; ctx.textAlign = 'left'; ctx.fillStyle = isDark ? '#7ba3c8' : '#2a4a70';
//     ['28', '26', '24', '22', '20', '18'].forEach((lbl, i) => { const y = barY + (i / 5) * barH; ctx.fillText(lbl, barX + barW + 4, y + 3); });
//     ctx.save(); ctx.translate(barX + barW + 26, barY + barH / 2); ctx.rotate(Math.PI / 2); ctx.textAlign = 'center';
//     ctx.font = `${Math.max(7, R * 0.065)}px "Share Tech Mono", monospace`; ctx.fillStyle = isDark ? '#4a6a8a' : '#5a7a9a';
//     ctx.fillText('Average CD', 0, 0); ctx.restore();
//     const titleY = cy - R - 12;
//     ctx.font = `bold ${Math.max(9, R * 0.1)}px "Share Tech Mono", monospace`; ctx.textAlign = 'center'; ctx.fillStyle = isDark ? '#7ba3c8' : '#2a4a70';
//     ctx.fillText('300mm Wafer CD Map', cx, titleY);
//     if (mapType === 'ssr') {
//         ctx.fillStyle = 'rgba(255,152,0,0.15)'; ctx.strokeStyle = 'rgba(255,152,0,0.6)'; ctx.lineWidth = 1;
//         const bx = cx - R + 2; const by = cy - R * 0.35; const bw = R * 0.9; const bh = 28;
//         ctx.beginPath(); ctx.rect(bx, by, bw, bh); ctx.fill(); ctx.stroke();
//         ctx.fillStyle = '#ff9800'; ctx.font = `bold ${Math.max(7, R * 0.07)}px "Share Tech Mono", monospace`; ctx.textAlign = 'center';
//         ctx.fillText('VISUALLY IDENTICAL', cx - R * 0.05, by + 10); ctx.fillText('TO HEATER FAIL.', cx - R * 0.05, by + 20);
//     }
// }
...
const Failure: React.FC = () => {
    ...
    const [ocapStepByScenario, setOcapStepByScenario] = useState<Record<number, number>>({});
    const [validationClicksByScenario, setValidationClicksByScenario] = useState<Record<number, { marathon: boolean; cdBaseline: boolean }>>({});

    // Derived "current scenario's" step — behaves like the old ocapStep/setOcapStep,
    // but keyed per scenario so each one tracks its own progress independently.
    const ocapStep = pebScenario ? (ocapStepByScenario[pebScenario] ?? 1) : 1;
    const setOcapStep = (step: number) => {
        if (!pebScenario) return;
        setOcapStepByScenario(prev => ({ ...prev, [pebScenario]: step }));
    };

    const validationClicks = pebScenario
        ? (validationClicksByScenario[pebScenario] ?? { marathon: false, cdBaseline: false })
        : { marathon: false, cdBaseline: false };

    const setValidationClicks = (
        updater:
            | { marathon: boolean; cdBaseline: boolean }
            | ((prev: { marathon: boolean; cdBaseline: boolean }) => { marathon: boolean; cdBaseline: boolean })
    ) => {
        if (!pebScenario) return;
        setValidationClicksByScenario(prev => {
            const current = prev[pebScenario] ?? { marathon: false, cdBaseline: false };
            const next = typeof updater === 'function' ? (updater as any)(current) : updater;
            return { ...prev, [pebScenario]: next };
        });
    };

    // requiredStep is optional — pass it whenever you know which step this button belongs to,
    // so we can tell "already completed this step" apart from "out of order" / "fully done".
    ...
    const handleOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
        if (ocapStep !== requiredStep) { showFlowError(ocapStep, requiredStep); return false; }
        alert(successMsg);
        if (nextStep) setOcapStep(nextStep);
        return true;
    };
    ...
    const showRdbFlowError = (current: number, requiredStep?: number) => {
        if (current >= 7) {
            alert("✅ This process is already completed.\nPlease refresh the page to start again from Step 1.");
        } else if (requiredStep !== undefined && current > requiredStep) {
            alert("✅ This step is already completed.");
    ...
    const handleRdbOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
        if (rdbOcapStep !== requiredStep) { showRdbFlowError(rdbOcapStep, requiredStep); return false; }
        alert(successMsg);
        if (nextStep) setRdbOcapStep(nextStep);
        return true;
    };
    ...
    const handleRdbActionClick = (actionType: 'filter' | 'bottle', successMsg: string) => {
        if (rdbOcapStep !== 4) { showRdbFlowError(rdbOcapStep, 4); return false; }
        alert(successMsg);
        setRdbActionsDone(prev => {
            const updated = { ...prev, [actionType]: true };
            if (dpMode === 'high') { if (updated.filter && updated.bottle) setRdbOcapStep(5); }
    ...
    const handleRdbRootCauseClick = () => {
        if (rdbOcapStep !== 3) { showRdbFlowError(rdbOcapStep, 3); return false; }
        if (dpMode === 'high') alert('Root cause completed: HIGH ΔP detected — filter replacement / filter prime required');
        else alert('Root cause completed: NORMAL ΔP detected — air pocket due to empty resist bottle');
        setRdbOcapStep(4);
        return true;
    ...
    const showEbrFlowError = (current: number, requiredStep?: number) => {
        if (current >= 7) {
            alert("✅ This process is already completed.\nPlease refresh the page to start again from Step 1.");
        } else if (requiredStep !== undefined && current > requiredStep) {
            alert("✅ This step is already completed.");
    ...
    const handleEbrOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
        if (ebrOcapStep !== requiredStep) { showEbrFlowError(ebrOcapStep, requiredStep); return false; }
        alert(successMsg);
        if (nextStep) setEbrOcapStep(nextStep);
        return true;
    };
    ...
    const showExfFlowError = (current: number, requiredStep?: number) => {
        if (current >= 7) {
            alert("✅ This process is already completed.\nPlease refresh the page to start again from Step 1.");
        } else if (requiredStep !== undefined && current > requiredStep) {
            alert("✅ This step is already completed.");
    ...
    const handleExfOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
        if (exfOcapStep !== requiredStep) { showExfFlowError(exfOcapStep, requiredStep); return false; }
        alert(successMsg);
        if (nextStep) setExfOcapStep(nextStep);
        return true;
    };
    ...
    const showDevFlowError = (current: number, requiredStep?: number) => {
        if (current >= 7) {
            alert("✅ This process is already completed.\nPlease refresh the page to start again from Step 1.");
        } else if (requiredStep !== undefined && current > requiredStep) {
            alert("✅ This step is already completed.");
    ...
    const handleDevOcapClick = (requiredStep: number, successMsg: string, nextStep?: number) => {
        if (devOcapStep !== requiredStep) { showDevFlowError(devOcapStep, requiredStep); return false; }
        alert(successMsg);
        if (nextStep) setDevOcapStep(nextStep);
        return true;
    };
    ...
    const handlePebRepairAction = (expectedScenario: 1 | 2 | 3, repairType: 'heater' | 'tc' | 'ssr', successMsg: string) => {
        if (ocapStep !== 4) { showFlowError(ocapStep, 4); return; }
        if (pebScenario !== expectedScenario) { alert('ERROR: REPLACED PART DOES NOT MATCH FAILURE SCENARIO'); return; }
        setSelectedRepair(repairType);
        alert(successMsg);
        setOcapStep(5);
    ...
    const handleDevActionClick = (actionType: "primary" | "flush", successMsg: string) => {
        if (devOcapStep !== 4) { showDevFlowError(devOcapStep, 4); return false; }
        alert(successMsg);
        setDevActionsDone(prev => {
            const updated = { ...prev, [actionType]: true };
            if (updated.primary && updated.flush) setDevOcapStep(5);
                        ...
                        {fm.name === "Resist Dispense Bubble" && (
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2.5">
                                ...
                                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
                                    ...
                                    <div className="font-mono text-[12px] text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded px-2 py-0.5">
                                        📡 SENSOR: {fm.rtmSensorLabel}
                                    </div>
                                    <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
                                        <Image src="/RTMPUMPResistDispenseBubble.png" alt="RTM Pump Pressure" width={1400} height={500} className="w-full h-auto block mt-7" />
                                    </div>
                                </div>
                                ...
                                {/* Wafer Defect Map */}
                                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
                                    <span className="font-mono text-sm font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ WAFER DEFECT MAP</span>
                                    <div className="w-full flex-1 min-h-[200px] rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                                        <Image src="/waffermapmodule.png" alt="Wafer Defect Map" width={400} height={320} className="w-full h-full object-fill block" />
                                    </div>
                                </div>
                                ...
                                <div className="lg:col-span-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5">
                                    <div className="flex items-center justify-between flex-wrap gap-1.5">
                                        <span className="font-mono text-sm font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ PROCESS SPC CHART Thickness Uniformity</span>
                                    </div>
                                    {fm.spcMetrics && (
                                        <div className="flex flex-wrap gap-1.5">
                                            <span className="font-mono text-[11px] px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700">{fm.spcMetrics[0]}</span>
                                        </div>
                                    )}
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                                        <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
                                            <Image src="/spc-ResistDispenseBubble.png" alt="SPC Chart" width={700} height={300} className="w-full h-auto block" style={{ marginBottom: '-3%', marginTop: '-5%' }} />
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <span className="font-mono text-[11px] px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 self-start -mt-8">Offline Defect Adder Count (KLA Scan)</span>
                                            <div className="flex-1 rounded-lg border border-gray-200 dark:border-gray-700 bg-white">
                                                <Image src="/defect-ResistDispenseBubble.png" alt="Offline Defect" width={500} height={400} className="w-full h-auto block" style={{ marginBottom: '-8%' }} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-2.5">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5">
                                    ...
                                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
                                        ...
                                        <div className="w-full h-78 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                                            <Image src="/EBBNozzleClogMisalignRTM.png" alt="EBR Nozzle RTM" width={1400} height={500} className="w-full h-full object-fill" />
                                        </div>
                                    </div>

                                    {/* Failure Diagnostics */}
                                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-1 flex flex-col gap-1 overflow-hidden hover:border-blue-500/30 transition-colors">
                                        <span className="font-mono text-sm font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ FAILURE DIAGNOSTICS</span>
                                ...
                                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5">
                                    ...
                                    <div className="flex  lg:flex-row flex-col gap-3 mt-2">
                                        <div className="md:col-span-1 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white h-100">
                                            <Image src="/EBBNozzleClogMisalignSPC.jpeg" alt="SPC Chart" width={700} height={300} className="w-full h-full object-fill" />
                                        </div>
                                        <div className=" flex lg:w-[25%] w-full flex-col p-3 gap-2 items-stretch">
                                            <div className="font-mono text-sm font-bold tracking-wider text-gray-500  w-full h-fit dark:text-gray-400">Offline Defect Adder Count</div>
                                            <div className="rounded-lg overflow-hidden w-full h-full border border-gray-200 dark:border-gray-700 bg-white  w-40">
                                                <Image src="/EBBNozzleClogMisaligndeffect.png" alt="Offline Defect" width={350} height={350} className="w-full h-90 object-fill" />
                                            </div>
                                        </div>
                                        <div className="md:col-span-1 bg-gray-100 dark:bg-gray-900 border border-gray-200 lg:w-[25%] w-full dark:border-gray-700 rounded-lg p-3 text-sm leading-relaxed text-gray-600 dark:text-gray-400 flex flex-col justify-between h-100">
                                            <div className="font-mono text-sm tracking-wider text-blue-600 dark:text-blue-400 mb-6">FAILURE MODE</div>
                                            <div className="text-xs font-bold text-gray-800 dark:text-gray-200 mb-1.5">EBR NOZZLE CLOG / MISALIGN</div>
                                            <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">FMEA Severity:</strong> 8/10 High</div>
                                            <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">Physics Impact:</strong> Clog reduces solvent momentum causing residual PR. Misalignment shifts removal boundary.</div>
                                            <div className="mb-1"><strong className="text-gray-800 dark:text-gray-200">RTM Sensor:</strong> EBR Solvent Flow Meter</div>
                        ...
                        {fm.name === "Exhaust Fan Failure" && (
                            <div className="flex flex-col gap-2.5">
                                ...
                                <div className="flex lg:flex-row flex-col gap-3 justify-between">
                                    ...
                                    <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white">
                                        <Image src="/viewthikness.png" alt="View Thickness" width={1200} height={780} className="w-full h-100 object-fill block mt-8" />
                                    </div>
                            ...
                            <div className="flex flex-col gap-2.5">
                                <div className="flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <div className="bg-white lg:w-[50%] w-full dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5 overflow-hidden hover:border-blue-500/30 transition-colors">
                                        ...
                                        <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
                                            <Image src="/DeveloperconcentrationRTM.png" alt="Developer Concentration RTM" width={1400} height={500} className="w-full h-auto block" style={{ marginBottom: '-8%', transform: 'scaleY(0.85)', transformOrigin: 'top' }} />
                                        </div>
                                    </div>

                                    {/* Info Panel */}
                                    <div className="bg-white lg:w-[50%] dark:bg-gray-800 border border-gray-200 dark:border-gray-700  p-2.5 flex flex-col gap-1.5 overflow-visible">
                                        <span className="font-mono text-xs font-bold tracking-wider text-gray-500 dark:text-gray-400">⬡ FAILURE MODE DEVELOPER CONCENTRATION</span>
                                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                                            <div className="flex-1 border border-gray-200 dark:border-gray-700  bg-white">
                                                <Image src="/regonia5thmodule.png" alt="Developer Concentration" width={240} height={500} className="w-full h-full block " />
                                            </div>
                                            <div className="w-78 bg-blue-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-md pt-20">
                                                <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">FMEA Severity:</strong> High</div>
                                                <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">Impact:</strong> Incorrect concentration causes CD variation and line slimming.</div>
                                                <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">RTM:</strong> Developer conductivity drift / concentration increase.</div>
                                                <div className="mb-3 text-sm text-gray-700 dark:text-gray-300"><strong className="text-blue-700 dark:text-blue-400">SPC:</strong> Offline CD-SEM critical dimension trend.</div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-2.5 pt-2.5 pb-1 flex flex-col gap-1.5">
                                        ...
                                        <div className="w-full rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white">
                                            <Image src="/DeveloperconcentrationSPC.png" alt="SPC Chart" width={700} height={500} className="w-full h-auto block" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-2.5 flex flex-col gap-1.5">
                                        ...
                                        <div className="flex-1 border border-gray-200 dark:border-gray-700 rounded-lg bg-white p-2">
                                            <Image src="/DeveloperConcentrationklascan.png" alt="Developer Concentration KLA Scan" width={700} height={500} className="w-full h-auto block" style={{ marginBottom: '-8%' }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 overflow-x-hidden">
            ...
            <div className="p-3 flex flex-col gap-2.5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-1.5 border border-gray-200 dark:border-gray-700 rounded-lg p-2 bg-white dark:bg-gray-800">
                    {FM_DATA.map((mode, idx) => (
                        <div
                            ...
                            onClick={() => selectFM(idx)}
                        >
                            <div className="text-lg font-extrabold text-gray-800 dark:text-gray-200 leading-tight tracking-wide">{mode.name}</div>
                        </div>
                    ))}
                </div>
                ...
                {(!isPEB || pebScenario) && (
                    <div className="flex flex-col sm:flex-row gap-2">
                        <button
                            className={`flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 font-sans text-lg font-bold tracking-wider text-gray-600 dark:text-gray-400 cursor-pointer transition-all duration-200 text-left ${(activeTab === 'rtmspc' || activeTab === null) ? 'border-blue-500 bg-gradient-to-br from-blue-500/15 to-blue-500/5 text-blue-600 dark:text-blue-400 shadow-[0_0_10px_rgba(0,102,204,0.14)]' : ''}`}
                            onClick={() => setActiveTab(activeTab === 'rtmspc' ? null : 'rtmspc')}
                        >
                            ⬡ Equipment RTM / Process SPC chart
                        </button>
                        <button
                            className={`flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 font-sans text-lg font-bold tracking-wider text-gray-600 dark:text-gray-400 cursor-pointer transition-all duration-200 text-left ${(activeTab === 'troubleshooting' || activeTab === 'ocap') ? 'border-blue-500 bg-gradient-to-br from-blue-500/15 to-blue-500/5 text-blue-600 dark:text-blue-400 shadow-[0_0_10px_rgba(0,102,204,0.14)]' : ''}`}
                            onClick={toggleTroubleshooting}
                        >
                            ⬡ Equipment troubleshooting, Process OCAP (Out of Control Action Plan)
                        </button>
                                    ...
                                    <div className="w-full overflow-x-auto">
                                        <table className="min-w-[720px] w-full border-collapse text-[9px] font-mono">
                                            ...
                                            <tbody>
                                                <tr className="border-b border-gray-200 dark:border-gray-800">
                                                    <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">HEATER FAIL</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">REDUCES TO AMBIENT</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">PINNED AT 100%</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500 font-extrabold">OPEN</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500">BURN SPOT</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">DOWN SHIFT, OOC</td>
                                                </tr>
                                                <tr className="border-b border-gray-200 dark:border-gray-800">
                                                    <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">TC BROKEN</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">FLUCTUATES</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">FLUCTUATES</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-red-900/30 text-red-500 font-extrabold">OPEN</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-green-900/30 text-green-500">OK</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">MORE VARIABILITY, OOC</td>
                                                </tr>
                                                <tr>
                                                    <td className="text-left px-3 py-1.5 font-bold text-gray-800 dark:text-gray-200 bg-black/20 whitespace-nowrap">SSR FAIL</td>
                                                    <td className="p-1.5 text-center border border-gray-200 dark:border-gray-800 text-sm bg-yellow-900/30 text-black-500">REDUCES TO AMBIENT</td>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 items-start">
                                        <div className="flex flex-col gap-2 flex-1">
                                            <button
                                                className="w-full bg-blue-500/10 border border-blue-500/40 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/20 hover:border-blue-500/80 hover:text-blue-400"
                                                onClick={() => {
                                                    if (ocapStep !== 5) { showFlowError(ocapStep, 5); return; }
                                                    alert('Running 5-wafer Marathon test — all zones heating normally.');
                                                    setValidationClicks(prev => ({ ...prev, marathon: true }));
                                                }}
                                            >
                                    ...
                                    <div className="border-t border-blue-500/15 pt-3 mt-1">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-2 items-start">
                                            <div className="flex flex-col gap-2 flex-1">
                                                <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
                                                    onClick={() => {
                                                        if (rdbOcapStep !== 5) { showRdbFlowError(rdbOcapStep, 5); return; }
                                                        alert('Running 3-wafer thickness check.');
                                                        setRdbValidationClicks(prev => ({ ...prev, thicknessCheck: true }));
                                                    }}>
                                                    Run 3 wafer thickness check
                                            ...
                                            <div className="min-w-[120px] bg-green-900/30 border border-green-500 rounded p-2 flex flex-col items-center gap-0.5 text-center flex-shrink-0">
                                                <div className="text-[10px] font-bold tracking-wide text-black-400 font-mono">THICKNESS UNIFORMITY</div>
                                                <div className="text-[12px] font-black tracking-wide text-black-400 font-mono">RETURNS TO &lt;1%</div>
                                                <div className="w-4/5 h-px bg-green-500/35 my-0.5" />
                                                <div className="text-[10px] font-black tracking-wide text-black-400 font-mono">SYSTEM STATUS: GREEN</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border-t border-blue-500/15 pt-3 mt-2">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-2 items-start">
                                            <div className="flex flex-col gap-2 flex-1">
                                                <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
                                                    onClick={() => {
                                                        if (ebrOcapStep !== 5) { showEbrFlowError(ebrOcapStep, 5); return; }
                                                        alert('Run EBR cycle on dummy wafer. Confirm flow 15.0 ml/min.');
                                                        setEbrValidationClicks(prev => ({ ...prev, dummyWafer: true }));
                                                    }}>
                                                    Run EBR width dummy wafer
                                ...
                                <div className="border border-gray-200 dark:border-gray-700 rounded-md p-3.5 bg-blue-500/5 flex flex-col flex-1">
                                    ...
                                    <div className="border-t border-blue-500/15 pt-3 mt-1">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <button className="w-full bg-gray-500/10 border border-gray-500/30 text-gray-700 dark:text-gray-300 py-2.5 px-3 rounded text-sm font-sans cursor-pointer text-left transition-colors duration-200 hover:bg-blue-500/15 hover:border-blue-500/70 hover:text-blue-400"
                                                onClick={() => {
                                                    if (exfOcapStep !== 5) { showExfFlowError(exfOcapStep, 5); return; }
                                                    alert('Running 3-wafer thickness check.');
                                                    setExfValidationClicks(prev => ({ ...prev, thicknessCheck: true }));
                                                }}>
                                                Run 3 wafer thickness check and dry monitor defect map
