...
//                                 }}>
//                                     <Image
//                                         src="/EBBNozzleClogMisaligndeffect.png"
...
//                             <div className="nm-chart-header">
//                                 <span className="nm-chart-title">⬡ PROCESS SPC CHART Thickness Uniformity </span>
...
//                                         <div className="nm-chart-tab-title">
//                                             📊 Offline Defect Adder Count (Edge Exclusion Zone)
//                                         </div>
...
//                                     <div className="ebr-root-switch-wrap">
//                                         <button
//                                             className="ebr-root-switch"
//                                             onClick={() =>
//                                                 setEbrRootMode(ebrRootMode === 'clog' ? 'misalign' : 'clog')
//                                             }
//                                         >
//                                             <span
//                                                 className={`ebr-root-switch-thumb ${ebrRootMode === 'misalign' ? 'right' : ''
//                                                     }`}
//                                             />
//                                         </button>

//                                         <div className="ebr-root-tabs">
//                                             <button
//                                                 className={`ebr-root-tab ${ebrRootMode === 'clog' ? 'active' : ''}`}
//                                                 onClick={() => setEbrRootMode('clog')}
//                                             >
//                                                 EBR Nozzle Clog
//                                             </button>

//                                             <button
//                                                 className={`ebr-root-tab ${ebrRootMode === 'misalign' ? 'active' : ''}`}
//                                                 onClick={() => setEbrRootMode('misalign')}
//                                             >
...
`,
    ...
    // =============================================
    {
        ...
        spcCpk: "0.41", spcSigma: "0.8σ",
        spcMetrics: ["Inline Thickness Uniformity (%)", ""],
        spcRulesTriggered: [
            "Rule 1: 1 Point outside 3-Sigma Control Limits (Action Limit)",
            "Rule 3: Outlier detection — data point statistically impossible for stable process",
        ],
                ...
                {(activeTab === null || activeTab === 'rtmspc') && (
                    <div className={`nm-charts-layout ${fm.name === "Resist Dispense Bubble" ? "fm002-charts-row" : ""}`}>
                        ...
                        {fm.name === "Developer Concentration" && (
                            <div className="nm-chart-panel" style={{ maxHeight: '360px', overflow: 'hidden' }}>
                                <div className="nm-chart-header">
                                    <span className="nm-chart-title">⬡ WAFER DEFECT TREND</span>
                                </div>
                                <div style={{
                                    width: '100%',
                                    flex: 1,
                                ...
                                <div className="dev-conc-spc-row">
                                    ...
                                    >
                                        ...
                                        <div className="nm-spc-dual-layout" style={{ display: "block" }}>
                                            <div className="nm-spc-left" style={{ width: "100%", height: "270px" }}>
                                                <div
                                    ...
                                    {/* RIGHT EXTRA CARD */}
                                    <div className="dev-conc-side-card">
                                        <div className="dev-conc-side-img-box">
                                            <Image
                                                src="/regonia5thmodule.png"
                                                alt="Developer Concentration"
                                                width={320}
                                                height={300}
                                                className="dev-conc-side-img"
                                            />
                                        </div>

                                        <div className="dev-conc-side-info-box">
                                            <div className="dev-conc-info-title">FAILURE MODE</div>
                                            <div className="dev-conc-info-main">DEVELOPER CONCENTRATION</div>
            ...
            <div className="main-content">
                ...
                <div
                    style={{
                        ...
                        marginBottom:
                            fm.name === "EBR Nozzle Clog/Misalign" || fm.name === "Developer Concentration"
                                ? "48px"
                                : "0px"
                    }}
                >
                    ...
                    {isPEB && (
                        <div style={{ flexShrink: 0, width: '540px' }}>
                            <Image
                                src="/thermo-couple.png"
                                alt="Thermocouple Image"
                                width={320}
                                height={300}
                                style={{ width: '2000px', height: '190px', borderRadius: '8px', display: 'block' }}
                            />
                        </div>
                    )}
                    ...
                    {fm.name === "Resist Dispense Bubble" && (
                        <div style={{ flexShrink: 0, width: '540px' }}>
                            <Image
                                ...
                                width={320}
                                height={300}
                                style={{ width: '500%', height: '200px', borderRadius: '8px', display: 'block' }}
                            />
                        </div>
                    )}
                        ...
                        style={
                            fm.name === "EBR Nozzle Clog/Misalign" || fm.name === "Developer Concentration"
                                ? {
                                    width: "93%",
                                    display: "grid",
                                    gridTemplateColumns: "1fr 1fr 0.43fr",
                                    gap: "8px",
                                    alignItems: "stretch",
